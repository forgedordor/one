...
public final class C0137r2 extends AbstractC0088h2 {
    public final /* synthetic */ long m;
    public final /* synthetic */ long n;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0137r2(AbstractC0093i2 abstractC0093i2, int i, long j, long j2) {
    ...
    public final G0 F(AbstractC0050a abstractC0050a, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (jT > 0 && spliterator.hasCharacteristics(16384)) {
            ...
            return AbstractC0171y1.y(abstractC0050a, A2.b(abstractC0050a2.D(), spliterator, this.m, this.n), true, intFunction);
        }
        ...
        Spliterator spliteratorO = abstractC0050a.O(spliterator);
        long j2 = this.m;
        long j3 = this.n;
        if (j2 <= jT) {
            long j4 = jT - j2;
        ...
        return AbstractC0171y1.y(this, new I3(spliteratorO, j, jMin), true, intFunction);
    }
    ...
    public final Spliterator G(AbstractC0050a abstractC0050a, Spliterator spliterator) {
        ...
        if (jT > 0 && spliterator.hasCharacteristics(16384)) {
            Spliterator spliteratorO = abstractC0050a.O(spliterator);
            long j2 = this.m;
            return new C3(spliteratorO, j2, A2.c(j2, j));
        }
        if (EnumC0094i3.ORDERED.x(abstractC0050a.f)) {
            return ((G0) new C0177z2(this, abstractC0050a, spliterator, new C0076f0(2), this.m, this.n).invoke()).spliterator();
        }
        Spliterator spliteratorO2 = abstractC0050a.O(spliterator);
        long j3 = this.m;
        if (j3 <= jT) {
            long jMin = jT - j3;
            if (j >= 0) {
        ...
        return new I3(spliteratorO2, j3, j);
    }

    @Override // j$.util.stream.AbstractC0050a
    public final InterfaceC0128p2 I(int i, InterfaceC0128p2 interfaceC0128p2) {
        return new C0133q2(interfaceC0128p2, this.m, this.n);
    }
}
