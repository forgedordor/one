...
public class C0039h extends C0038g implements java.util.List, List {
    private static final long serialVersionUID = -7754090372962971524L;
    public final java.util.List c;

    public C0039h(java.util.List list) {
        super(list);
        this.c = list;
    }
    ...
    private Object readResolve() {
        ...
        return list instanceof RandomAccess ? new C0041j(list) : this;
    }
    ...
    public java.util.List subList(int i, int i2) {
        C0039h c0039h;
        synchronized (this.b) {
            c0039h = new C0039h(this.c.subList(i, i2), this.b);
        }
        return c0039h;
    }
    ...
    public C0039h(java.util.List list, Serializable serializable) {
