...
public final class ZoneOffset extends ZoneId implements TemporalAccessor, TemporalAdjuster, Comparable<ZoneOffset>, Serializable {
    ...
    public static ZoneOffset N(Temporal temporal) {
        Objects.a(temporal, "temporal");
        ZoneOffset zoneOffset = (ZoneOffset) temporal.I(j$.time.temporal.k.d);
        if (zoneOffset != null) {
            return zoneOffset;
        }
        throw new DateTimeException(c.d("Unable to obtain ZoneOffset from TemporalAccessor: ", String.valueOf(temporal), " of type ", temporal.getClass().getName()));
    }
    ...
    */
    ...
    public static int Q(String str, int i, boolean z) {
        if (z && str.charAt(i - 1) != ':') {
    ...
    public static ZoneOffset R(ObjectInput objectInput) throws IOException {
    ...
    public final Object I(j$.desugar.sun.nio.fs.n nVar) {
        return (nVar == j$.time.temporal.k.d || nVar == j$.time.temporal.k.e) ? this : j$.time.temporal.k.c(this, nVar);
    }
    ...
    public final int get(TemporalField temporalField) {
        ...
        return j$.time.temporal.k.d(this, temporalField).a(A(temporalField), temporalField);
    }
