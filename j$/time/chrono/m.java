...
public final class m extends AbstractC0019a implements Serializable {
    ...
    static {
        m mVar = new m();
        m = mVar;
        AbstractC0019a.x(mVar, "Hijrah");
        AbstractC0019a.x(mVar, "islamic");
    }
    ...
    public final void L() {
        ...
        try {
            ...
            this.h = 15600;
            this.f = epochDay;
            int[] iArrM = M(epochDay, map);
            this.e = iArrM;
            this.g = iArrM[3612];
            for (int i2 = 1300; i2 < 1600; i2++) {
                int iR = R(i2, 12);
                this.k = Math.min(this.k, iR);
                this.l = Math.max(this.l, iR);
            }
            this.d = true;
        } catch (Exception e) {
    ...
    public final List eras() {
        return j$.desugar.sun.nio.fs.g.N(p.values());
    }
    ...
    public final boolean isLeapYear(long j) {
        L();
        return j >= ((long) N(0)) && j <= ((long) (N(this.e.length - 1) - 1)) && R((int) j, 12) > 354;
    }

    @Override // j$.time.chrono.AbstractC0019a
    public final ChronoLocalDate j() {
        return new o(this, LocalDate.S(j$.desugar.sun.nio.fs.g.Z()).A(ChronoField.EPOCH_DAY));
    }
    ...
    public final j$.time.temporal.m q(ChronoField chronoField) {
        ...
        switch (l.a[chronoField.ordinal()]) {
            case 1:
                return j$.time.temporal.m.g(1L, this.i, this.j);
            case 2:
                return j$.time.temporal.m.f(1L, this.l);
            case 3:
                return j$.time.temporal.m.f(1L, 5L);
            case 4:
            case 5:
                return j$.time.temporal.m.f(N(0), N(this.e.length - 1) - 1);
            case 6:
                return j$.time.temporal.m.f(1L, 1L);
            default:
                return chronoField.d;
        }
    }
    ...
    public final ChronoLocalDate z(TemporalAccessor temporalAccessor) {
        return temporalAccessor instanceof o ? (o) temporalAccessor : new o(this, temporalAccessor.A(ChronoField.EPOCH_DAY));
    }
}
