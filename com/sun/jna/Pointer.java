...
public class Pointer {
    ...
    private static class Opaque extends Pointer {
        ...
        public String toString() {
            return "const@0x".concat(String.valueOf(Long.toHexString(this.peer)));
        }
        ...
        private Opaque(long j) {
            super(j);
            this.MSG = "This pointer is opaque: ".concat(toString());
        }
    ...
    public static final Pointer createConstant(int i) {
        return new Opaque(i & 4294967295L);
    }
    ...
    private void readArray(long j, Object obj, Class<?> cls) {
        ...
        if (!Structure.class.isAssignableFrom(cls)) {
            if (!NativeMapped.class.isAssignableFrom(cls)) {
                throw new IllegalArgumentException(a.I(cls, "Reading array of ", " from memory not supported"));
            }
        ...
        for (int i2 = 1; i2 < structureArr.length; i2++) {
            ...
            if (structure == null) {
                ...
                structure.useMemory(this, (int) ((structure.size() * i2) + j), true);
    ...
    private void writeArray(long j, Object obj, Class<?> cls) {
        ...
        if (!Structure.class.isAssignableFrom(cls)) {
            if (!NativeMapped.class.isAssignableFrom(cls)) {
                throw new IllegalArgumentException(a.I(cls, "Writing array of ", " to memory not supported"));
            }
            NativeMapped[] nativeMappedArr = (NativeMapped[]) obj;
            NativeMappedConverter nativeMappedConverter = NativeMappedConverter.getInstance(cls);
        ...
        if (Structure.ByReference.class.isAssignableFrom(cls)) {
            ...
            for (int i2 = 0; i2 < structureArr.length; i2++) {
                ...
                if (structure == null) {
                    ...
                    pointerArr2[i2] = structure.getPointer();
        ...
        for (int i3 = 1; i3 < structureArr.length; i3++) {
            ...
            if (structure2 == null) {
                ...
                structure2.useMemory(this, (int) ((structure2.size() * i3) + j), true);
            }
    ...
    public String dump(long j, int i) {
        StringWriter stringWriter = new StringWriter(i + i + 13 + ((i / 4) * 4));
    ...
    public Object getValue(long j, Class<?> cls, Object obj) {
        ...
        if (Platform.HAS_BUFFERS && Buffer.class.isAssignableFrom(cls)) {
            ...
            if (obj == null) {
                ...
                directBufferPointer = Native.getDirectBufferPointer((Buffer) obj);
            }
        ...
        if (NativeMapped.class.isAssignableFrom(cls)) {
            ...
            if (nativeMapped != null) {
                ...
                return true == nativeMapped.equals(objFromNative) ? nativeMapped : objFromNative;
            }
            NativeMappedConverter nativeMappedConverter = NativeMappedConverter.getInstance(cls);
            return nativeMappedConverter.fromNative(getValue(j, nativeMappedConverter.nativeType(), null), new FromNativeContext(cls));
        }
        if (!cls.isArray()) {
            throw new IllegalArgumentException(a.I(cls, "Reading \"", "\" from memory is not supported"));
        }
        if (obj == null) {
    ...
    public void setValue(long j, Object obj, Class<?> cls) {
        if (cls == Boolean.TYPE || cls == Boolean.class) {
            setInt(j, true == Boolean.TRUE.equals(obj) ? -1 : 0);
            return;
        }
        if (cls == Byte.TYPE || cls == Byte.class) {
        ...
        if (NativeMapped.class.isAssignableFrom(cls)) {
            ...
            if (!cls.isArray()) {
                throw new IllegalArgumentException(a.I(cls, "Writing ", " to memory is not supported"));
            }
    ...
    public String toString() {
        return "native@0x".concat(String.valueOf(Long.toHexString(this.peer)));
    }
    ...
    public void setString(long j, String str, String str2) {
        ...
        write(j, bytes, 0, length);
        setByte(length + j, (byte) 0);
    }
