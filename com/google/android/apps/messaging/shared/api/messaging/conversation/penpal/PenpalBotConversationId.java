...
public final class PenpalBotConversationId implements ConversationId {
    public static final Parcelable.Creator<ConversationId> CREATOR = new akkt();
    public final ConversationIdType a;
    public final BugleConversationId b;

    public PenpalBotConversationId(ConversationIdType conversationIdType) {
        boolean z = false;
    ...
    public static PenpalBotConversationId c(String str) {
        return new PenpalBotConversationId(barn.b(str));
    }

    @Override // com.google.android.apps.messaging.shared.api.messaging.conversation.ConversationId
    public final aklm a() {
        return aklm.PENPAL_BOT;
    }
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof PenpalBotConversationId) {
            return this.a.equals(((PenpalBotConversationId) obj).a);
        }
        return false;
    }
