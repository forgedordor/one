package com.google.android.apps.messaging.shared.util.spam.spatula.safetycoremissing;
...
public final class SafetycoreInstallRedirectActivity extends csmz implements ehlg, ehld, ehnq {
    private csnb o;
    private boolean q;
    private Context r;
    private lvn t;
    ...
    public SafetycoreInstallRedirectActivity() {
        x(new csna(this));
    }
        ...
        if (this.o == null) {
            ...
            try {
                ...
                try {
                    try {
                        Object objBb = bb();
                        this.o = new csnb((Context) ((ahhk) objBb).d.b(), ((ahhk) objBb).b.a.Ji);
                        eieuVarK.close();
    ...
    @Override // defpackage.csmz, defpackage.eg, defpackage.abi, defpackage.hl, android.app.Activity
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            l();
            csnb csnbVar = this.o;
            ((cgkj) csnbVar.c.b()).c(cglf.NT_SAFETYCORE_MISSING);
            eiid.o(csnbVar.b, csnb.a);
            this.q = false;
            eibpVar.m();
            eifpVarT.close();
        } catch (Throwable th) {
    ...
    @Override // defpackage.csmz, defpackage.eg, android.app.Activity
