...
public final class ArchivedActivity extends acoi implements ehlg, ehld, ehnq {
    private boolean M;
    private Context N;
    private lvn P;
    private boolean Q;
        ...
        try {
            ...
            try {
                try {
                    ...
                    if (!(activity instanceof ArchivedActivity)) {
                        throw new IllegalStateException(a.L(activity, acoa.class, "Attempt to inject a Activity wrapper of type "));
                    }
                    ArchivedActivity archivedActivity = (ArchivedActivity) activity;
                    archivedActivity.getClass();
                    daip daipVar = (daip) ((ahhk) objBb).l.b();
                    eyik eyikVar = ((ahhk) objBb).x;
                    eyik eyikVar2 = ((ahhk) objBb).y;
                    ahkn ahknVar = ((ahhk) objBb).b;
                    this.n = new acoa(archivedActivity, daipVar, eyikVar, eyikVar2, ahknVar.b.jd, ahknVar.a.adE);
                    eieuVarK.close();
                    this.n.d = this;
    ...
    protected final void fw(im imVar) {
        super.fw(imVar);
        acoa acoaVarM = M();
        ArchivedActivity archivedActivity = acoaVarM.a;
        Toolbar toolbarFb = archivedActivity.fb();
        daip daipVar = acoaVarM.c;
        acoc.b(archivedActivity, toolbarFb, imVar, R.string.archived_activity_title);
    }
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            if (((asgn) acoaVarM.b.b()).a()) {
                abl.a(acoaVarM.a);
            }
            acoaVarM.a.setContentView(R.layout.home_activity_with_fragment_container);
            this.M = false;
            eibpVar.m();
            eifpVarT.close();
        } catch (Throwable th) {
