...
public final class FiSettingsActivity extends trz implements ehlg, ehld, ehnq {
    private tqq L;
    private boolean N;
    private Context O;
    private lvn Q;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof FiSettingsActivity)) {
                            throw new IllegalStateException(a.L(activity, tqq.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        FiSettingsActivity fiSettingsActivity = (FiSettingsActivity) activity;
                        fiSettingsActivity.getClass();
                        this.L = new tqq(fiSettingsActivity, (efxf) ((ahhk) objBb).x.b(), (ains) ((ahhk) objBb).b.a.c.b());
                        eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            einf.a(this, trv.class, new tqr(this.L));
            this.N = false;
            eibpVar.m();
            eifpVarT.close();
        } catch (Throwable th) {
