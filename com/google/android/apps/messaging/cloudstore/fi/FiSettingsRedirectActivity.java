...
public final class FiSettingsRedirectActivity extends tsb implements ehlg, ehld, ehnq {
    private trl L;
    private boolean N;
    private Context O;
    private lvn Q;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof FiSettingsRedirectActivity)) {
                            throw new IllegalStateException(a.L(activity, trl.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        FiSettingsRedirectActivity fiSettingsRedirectActivity = (FiSettingsRedirectActivity) activity;
                        fiSettingsRedirectActivity.getClass();
                        this.L = new trl(fiSettingsRedirectActivity, ((ahhk) objBb).y, ((ahhk) objBb).x);
                        eieuVarK.close();
