...
public final class IdentityDetailsActivity extends ahcd implements ehlg, ehld, ehnq {
    private boolean I;
    private Context J;
    private lvn L;
    private boolean M;
        ...
        if (this.n == null) {
            ...
            try {
                ...
                try {
                    try {
                        Object objBb = bb();
                        eyik eyikVar = ((ahhk) objBb).aT;
                        ahkn ahknVar = ((ahhk) objBb).b;
                        this.n = new ahcf(eyikVar, ahknVar.dL, ahknVar.id);
                        eieuVarK.close();
    ...
    /* JADX WARN: Type inference failed for: r0v3, types: [ehoa, java.lang.Object] */
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            ahcf ahcfVarM = M();
            if (((bvur) ahcfVarM.c.b()).m()) {
                try {
                    ahciVar = (ahci) ProtoParsers.c(((IdentityDetailsActivity) ahcfVarM.b.b()).getIntent(), "arguments", ahci.a, evrr.a());
                } catch (evtj e) {
                    ekrw ekrwVarJ = ahcf.a.j();
                    ekrwVarJ.X(eksq.a, "Bugle");
                    ((ekrd) ((ekrd) ((ekrd) ekrwVarJ).g(e)).h("com/google/android/apps/messaging/privacy/identitydetails/IdentityDetailsActivityPeer", "parseArguments", 'C', "IdentityDetailsActivityPeer.java")).q("Failed to show encryption verification activity.");
                    ahciVar = null;
                }
                ahciVar.getClass();
                ahcj ahcjVar = new ahcj();
                eyhj.e(ahcjVar);
                ehog.a(ahcjVar, ahciVar);
                fcsu fcsuVar = ahcfVarM.b;
                Context applicationContext = ((IdentityDetailsActivity) fcsuVar.b()).getApplicationContext();
                im imVarK = ((IdentityDetailsActivity) fcsuVar.b()).k();
                if (imVarK != null) {
                    Resources resources = applicationContext.getResources();
                    cukg.b(imVarK, resources.getString(R.string.security_key_top_level_title));
                }
                ((IdentityDetailsActivity) fcsuVar.b()).setContentView(R.layout.identity_details_activity);
                cg cgVar = new cg(((IdentityDetailsActivity) fcsuVar.b()).a());
                cgVar.t(R.id.identity_details_fragment_container, ahcjVar, "IDENTITY_DETAILS_FRAGMENT_V3");
                cgVar.c();
            }
            this.I = false;
            this.H.m();
    ...
    public final boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        try {
            ...
            if (menuItem.getItemId() == 16908332) {
                ((IdentityDetailsActivity) ahcfVarM.b.b()).c().d();
                z = true;
            } else {
                z = false;
            }
