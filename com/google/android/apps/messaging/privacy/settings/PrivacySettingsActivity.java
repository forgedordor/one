...
public final class PrivacySettingsActivity extends ahdb implements ehlg, ehld, ehnq {
    private ahde L;
    private boolean N;
    private Context O;
    private lvn Q;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof PrivacySettingsActivity)) {
                            throw new IllegalStateException(a.L(activity, ahde.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        PrivacySettingsActivity privacySettingsActivity = (PrivacySettingsActivity) activity;
                        privacySettingsActivity.getClass();
                        ahkn ahknVar = ((ahhk) objBb).b;
                        this.L = new ahde(privacySettingsActivity, (bvur) ahknVar.dL.b(), (bwfx) ahknVar.id.b());
                        eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            final ahde ahdeVarM = M();
            PrivacySettingsActivity privacySettingsActivity = ahdeVarM.a;
            ...
            bvur bvurVar = ahdeVarM.b;
            if (bvurVar.n()) {
                bwfx bwfxVar = ahdeVarM.c;
                ...
                String strC = bvurVar.c();
                if (!TextUtils.isEmpty(strC)) {
                    String strA = cpef.a(context);
                    spannableStringBuilder = dajs.g(context, spannableStringBuilder.append((CharSequence) "\n\n").append((CharSequence) strA).toString(), strA);
                    final Uri uriA = dajs.a(strC, context);
                    textView.setOnClickListener(new View.OnClickListener() { // from class: ahdd
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            ahdeVarM.a.startActivity(new Intent("android.intent.action.VIEW").setData(uriA));
                        }
                    });
                }
            ...
            eyhj.e(ahdfVar);
            cgVar.D(R.id.privacy_preference_fragment_container, ahdfVar);
            cgVar.c();
            this.N = false;
            eibpVar.m();
            eifpVarT.close();
