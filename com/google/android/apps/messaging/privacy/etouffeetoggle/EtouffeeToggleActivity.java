...
public final class EtouffeeToggleActivity extends ahca implements ehlg, ehld, ehnq {
    private ahbo L;
    private boolean N;
    private Context O;
    private lvn Q;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof EtouffeeToggleActivity)) {
                            throw new IllegalStateException(a.L(activity, ahbo.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        ...
                        this.L = new ahbo(etouffeeToggleActivity, ahknVar.dL, ahknVar.id);
                        eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            final ahbo ahboVarM = M();
            EtouffeeToggleActivity etouffeeToggleActivity = ahboVarM.a;
            etouffeeToggleActivity.getWindow().setStatusBarColor(0);
            TextView textView = (TextView) etouffeeToggleActivity.findViewById(R.id.etouffee_toggle_info_text_id);
            Context context = textView.getContext();
            fcsu fcsuVar = ahboVarM.b;
            if (((bvur) fcsuVar.b()).n()) {
                fcsu fcsuVar2 = ahboVarM.c;
                ...
                if (!TextUtils.isEmpty(strE)) {
                    ...
                    final Uri uriA = dajs.a(strE, context);
                    textView.setOnClickListener(new View.OnClickListener() { // from class: ahbn
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            ahboVarM.a.startActivity(new Intent("android.intent.action.VIEW").setData(uriA));
                        }
                    });
                }
            ...
            cg cgVar = new cg(etouffeeToggleActivity.a());
            ahbp ahbpVar = new ahbp();
            eyhj.e(ahbpVar);
            cgVar.D(R.id.etouffee_toggle_fragment_container, ahbpVar);
            cgVar.c();
            this.N = false;
            eibpVar.m();
            eifpVarT.close();
