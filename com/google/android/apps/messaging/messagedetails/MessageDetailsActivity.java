package com.google.android.apps.messaging.messagedetails;
...
public final class MessageDetailsActivity extends afkq implements ehlg, ehld, ehnq {
    private boolean M;
    private Context N;
    private lvn P;
    private boolean Q;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof MessageDetailsActivity)) {
                            throw new IllegalStateException(a.L(activity, afks.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        MessageDetailsActivity messageDetailsActivity = (MessageDetailsActivity) activity;
                        messageDetailsActivity.getClass();
                        efxf efxfVar = (efxf) ((ahhk) objBb).x.b();
                        ahkn ahknVar = ((ahhk) objBb).b;
                        this.n = new afks(messageDetailsActivity, efxfVar, (egkc) ahknVar.a.aow.b(), ahknVar.b.kr);
                        eieuVarK.close();
    ...
    public final cuhe fa() {
        return ((asgs) M().c.b()).a() ? cuhe.o : cuhe.k;
    }
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            afks afksVarM = M();
            if (((asgs) afksVarM.c.b()).a()) {
                abl.a(afksVarM.b);
            } else {
                Window window = afksVarM.b.getWindow();
                lfq.a(window, false);
            ...
            einf.a(this, agbg.class, new afkt(this.n));
            this.M = false;
            eibpVar.m();
            eifpVarT.close();
        } catch (Throwable th) {
