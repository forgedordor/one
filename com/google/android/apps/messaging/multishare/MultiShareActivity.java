package com.google.android.apps.messaging.multishare;
...
public final class MultiShareActivity extends aflv implements ehlg, ehld, ehnq {
    private boolean M;
    private Context N;
    private lvn P;
    private boolean Q;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof MultiShareActivity)) {
                            throw new IllegalStateException(a.L(activity, aflx.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        MultiShareActivity multiShareActivity = (MultiShareActivity) activity;
                        multiShareActivity.getClass();
                        this.n = new aflx(multiShareActivity, ((ahhk) objBb).x, ((ahhk) objBb).y);
                        eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            einf.a(this, agbg.class, new afly(this.n));
            this.M = false;
            eibpVar.m();
            eifpVarT.close();
        } catch (Throwable th) {
