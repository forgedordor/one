...
public final class DebugMobileConfigurationActivity extends cxsy implements ehlg, ehld, ehnq {
    private cxbi n;
    private boolean p;
    private Context q;
    private lvn y;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof DebugMobileConfigurationActivity)) {
                            throw new IllegalStateException(a.L(activity, cxbi.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        DebugMobileConfigurationActivity debugMobileConfigurationActivity = (DebugMobileConfigurationActivity) activity;
                        debugMobileConfigurationActivity.getClass();
                        this.n = new cxbi(debugMobileConfigurationActivity);
                        eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            J().a.setContentView(R.layout.debug_mobile_configuration_activity);
            this.p = false;
            eibpVar.m();
            eifpVarT.close();
        } catch (Throwable th) {
