package com.google.android.apps.messaging.ui.debug.database;
...
public final class DatabaseActivity extends cyit implements ehlg, ehld, ehnq {
    private cygl n;
    private boolean p;
    private Context q;
    private lvn y;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof DatabaseActivity)) {
                            throw new IllegalStateException(a.L(activity, cygl.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        DatabaseActivity databaseActivity = (DatabaseActivity) activity;
                        databaseActivity.getClass();
                        this.n = new cygl(databaseActivity);
                        eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            cygl cyglVarJ = J();
            if (bundle == null) {
                cg cgVar = new cg(cyglVarJ.a.a());
                cyhb cyhbVar = new cyhb();
                eyhj.e(cyhbVar);
                cgVar.s(R.id.content, cyhbVar);
                cgVar.c();
            }
            this.p = false;
            eibpVar.m();
