package com.google.android.apps.messaging.ui.debug.workqueue.pwqui;
...
public final class PwqDebugUiActivity extends cylm implements ehlg, ehld, ehnq {
    private cylo n;
    private boolean p;
    private Context q;
    private lvn y;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof PwqDebugUiActivity)) {
                            throw new IllegalStateException(a.L(activity, cylo.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        PwqDebugUiActivity pwqDebugUiActivity = (PwqDebugUiActivity) activity;
                        pwqDebugUiActivity.getClass();
                        this.n = new cylo(pwqDebugUiActivity);
                        eieuVarK.close();
