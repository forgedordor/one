package com.google.android.apps.messaging.ui.debug.cloudstore.d2d;
...
public final class D2dToolsActivity extends cybl implements ehlg, ehld, ehnq {
    private cyao n;
    private boolean p;
    private Context q;
    private lvn y;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof D2dToolsActivity)) {
                            throw new IllegalStateException(a.L(activity, cyao.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        D2dToolsActivity d2dToolsActivity = (D2dToolsActivity) activity;
                        d2dToolsActivity.getClass();
                        this.n = new cyao(d2dToolsActivity);
                        eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            cyar cyarVar = new cyar();
            eyhj.e(cyarVar);
            cgVar.s(R.id.content, cyarVar);
            cgVar.c();
            this.p = false;
            eibpVar.m();
            eifpVarT.close();
