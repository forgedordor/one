package com.google.android.apps.messaging.ui.debug.cloudstore.keyretrievalclient;
...
public final class KeyRetrievalClientActivity extends cybs implements ehlg, ehld, ehnq {
    private cybu n;
    private boolean p;
    private Context q;
    private lvn y;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof KeyRetrievalClientActivity)) {
                            throw new IllegalStateException(a.L(activity, cybu.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        KeyRetrievalClientActivity keyRetrievalClientActivity = (KeyRetrievalClientActivity) activity;
                        keyRetrievalClientActivity.getClass();
                        this.n = new cybu(keyRetrievalClientActivity);
                        eieuVarK.close();
