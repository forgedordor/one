package com.google.android.apps.messaging.ui.debug.cloudstore.analysisui;
...
public final class CmsSyncAnalysisActivity extends cxxj implements ehlg, ehld, ehnq {
    private cxwm n;
    private boolean p;
    private Context q;
    private lvn y;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof CmsSyncAnalysisActivity)) {
                            throw new IllegalStateException(a.L(activity, cxwm.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        CmsSyncAnalysisActivity cmsSyncAnalysisActivity = (CmsSyncAnalysisActivity) activity;
                        cmsSyncAnalysisActivity.getClass();
                        this.n = new cxwm(cmsSyncAnalysisActivity);
                        eieuVarK.close();
