...
import defpackage.cxbp;
import defpackage.cxbq;
...
public final class DebugPrefsFragment extends cxtc implements ehlg, eyhx, ehlc, ehnw, eifl {
    private cxbq a;
    private boolean ag;
    private Context d;
    ...
    public final View M(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        try {
            ...
            View viewInflate = layoutInflater.inflate(R.layout.debug_prefs_fragment, viewGroup, false);
            View viewFindViewById = viewInflate.findViewById(android.R.id.list);
            viewFindViewById.getClass();
            ((ListView) viewFindViewById).setAdapter((ListAdapter) new cxbp(layoutInflater));
    ...
    @Override // defpackage.cxtc, defpackage.ecdo, defpackage.ea
    ...
    @Override // defpackage.cxtc, defpackage.ehnp, defpackage.ea
    public final void g(Context context) {
        ...
        try {
            ...
            if (this.a == null) {
                try {
                    eieu eieuVarG = eiiy.g("com/google/android/apps/messaging/ui/debug/DebugPrefsFragment", 85, DebugPrefsFragment.class, "CreateComponent");
                    try {
                        bb();
                        eieuVarG.close();
                        eieu eieuVarG2 = eiiy.g("com/google/android/apps/messaging/ui/debug/DebugPrefsFragment", 90, DebugPrefsFragment.class, "CreatePeer");
                        try {
                            this.a = new cxbq();
                            eieuVarG2.close();
    ...
    @Override // defpackage.cxtc, defpackage.ea
