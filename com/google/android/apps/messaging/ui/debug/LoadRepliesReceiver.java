...
public final class LoadRepliesReceiver extends cxti {
    public static final cqce a = cqce.g("BugleReplies", "LoadRepliesReceiver");
    public fcsu b;
    public fcsu c;
    public eygg d;
    public fcsu e;
    ...
    public final eieh b() {
        ...
        return ((eigp) fcsuVar.b()).a("LoadRepliesReceiver receive broadcast");
    }
    ...
    public final eiju c(Context context, Intent intent) {
        context.getClass();
        intent.getClass();
        if (fdbq.f(intent.getAction(), "com.google.android.apps.messaging.load_replies")) {
            List listAj = fcva.aj(fdey.g(fdey.l(fdey.h(fczv.a(new BufferedReader(new InputStreamReader(new FileInputStream((File) LoadMessagesReceiver.c.a(intent, context, "single_conversation_replies.csv")), fdfy.a), 8192)), ((Number) LoadMessagesReceiver.b.invoke(intent)).intValue()), ((Number) LoadMessagesReceiver.a.invoke(intent)).intValue())));
            ...
            objB.getClass();
            q("LoadReplies", auvw.c((fdjx) objB, fcyi.a, fdjz.a, new cxui(this, it, null)));
        } else {
