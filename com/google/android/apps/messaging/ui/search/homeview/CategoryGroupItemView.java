...
public final class CategoryGroupItemView extends daal implements ehlg<daaf> {
    private daaf a;
    private Context b;
    ...
    public CategoryGroupItemView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
    }

    public CategoryGroupItemView(Context context, AttributeSet attributeSet, int i, int i2) {
        super(context, attributeSet, i, i2);
    }

    public CategoryGroupItemView(ehmt ehmtVar) {
        super(ehmtVar);
        d();
    }
}
