...
public final class RichCardsSettingsActivity extends cuqp implements ehlg, ehld, ehnq {
    private cuxg L;
    private boolean N;
    private Context O;
    private lvn Q;
    ...
    private final void N() {
        ...
        try {
            ...
            try {
                try {
                    Object objBb = bb();
                    this.L = new cuxg(((ahhk) objBb).P(), (aijh) ((ahhk) objBb).b.a.Uk.b(), ((ahhk) objBb).P(), ((ahhk) objBb).x, ((ahhk) objBb).y);
                    eieuVarK.close();
    ...
    protected final int C() {
        M();
        return R.layout.rich_cards_settings_activity_gm3;
    }
    ...
    protected final Integer G() {
        M();
        return Integer.valueOf(R.id.rich_card_settings_container);
    }
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            final cuxg cuxgVarM = M();
            RichCardsSettingsActivity richCardsSettingsActivity = cuxgVarM.b;
            richCardsSettingsActivity.getWindow().setStatusBarColor(0);
            TextView textView = (TextView) richCardsSettingsActivity.findViewById(R.id.rich_cards_preference_info_text_id);
            textView.setOnClickListener(new View.OnClickListener() { // from class: cuxe
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    String str = (String) ccze.u.e();
                    cuxg cuxgVar = cuxgVarM;
                    cuxgVar.a.t(cuxgVar.b, str);
                }
            });
            SpannableStringBuilder spannableStringBuilderD = dajs.d(richCardsSettingsActivity, R.string.new_rich_cards_preference_info_text);
