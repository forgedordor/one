...
public final class ProtectionSafetySettingsActivity extends cvds implements ehlg, ehld, ehnq {
    private cvdw L;
    private boolean N;
    private Context O;
    private lvn Q;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof ProtectionSafetySettingsActivity)) {
                            throw new IllegalStateException(a.L(activity, cvdw.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        ProtectionSafetySettingsActivity protectionSafetySettingsActivity = (ProtectionSafetySettingsActivity) activity;
                        protectionSafetySettingsActivity.getClass();
                        this.L = new cvdw(protectionSafetySettingsActivity);
                        eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            ProtectionSafetySettingsActivity protectionSafetySettingsActivity = M().a;
            cg cgVar = new cg(protectionSafetySettingsActivity.a());
            protectionSafetySettingsActivity.setTitle(protectionSafetySettingsActivity.getString(R.string.protection_safety_settings));
            cvdy cvdyVar = new cvdy();
            eyhj.e(cvdyVar);
            cgVar.D(R.id.fragment_container, cvdyVar);
            cgVar.c();
            this.N = false;
            eibpVar.m();
            eifpVarT.close();
