...
import defpackage.emfc;
import defpackage.emfe;
...
public final class RcsSettingsActivity extends cuqm implements ehlg, ehld, ehnq {
    private cuvl L;
    private boolean N;
    private Context O;
    private lvn Q;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof RcsSettingsActivity)) {
                            throw new IllegalStateException(a.L(activity, cuvl.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        ...
                        this.L = new cuvl(rcsSettingsActivity, (ains) ahnhVar.c.b(), ahnhVar.Uz, ahknVar.b.jn);
                        eieuVarK.close();
    ...
    protected final void onActivityResult(int i, int i2, Intent intent) {
        ...
        try {
            ...
            ea eaVarG = M().a.a().g(R.id.fragment_container);
            if (eaVarG != null) {
                eaVarG.af(i, i2, intent);
            }
            eifpVarR.close();
        } catch (Throwable th) {
            try {
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            cuvl cuvlVarM = M();
            RcsSettingsActivity rcsSettingsActivity = cuvlVarM.a;
            im imVarK = rcsSettingsActivity.k();
            if (imVarK != null) {
                imVarK.setDisplayHomeAsUpEnabled(true);
                imVarK.setTitle(R.string.rcs_settings_activity_title_v2);
            }
            if (bundle == null) {
                String stringExtra = rcsSettingsActivity.getIntent() != null ? rcsSettingsActivity.getIntent().getStringExtra("open_setting_directly") : null;
                Bundle bundle2 = new Bundle();
                bundle2.putString("open_setting_directly", stringExtra);
                cg cgVar = new cg(rcsSettingsActivity.a());
                cuvm cuvmVar = new cuvm();
                eyhj.e(cuvmVar);
                cuvmVar.at(bundle2);
                cgVar.D(R.id.fragment_container, cuvmVar);
                cgVar.c();
                cuvlVarM.b.c("Bugle.UI.Settings.Advanced.Rcs");
                ((cjya) cuvlVarM.d.b()).e(emfc.RCS_PROVISIONING_SETTINGS_CHAT_FEATURES_SCREEN_SEEN, emfe.PROVISIONING_UI_TYPE_SETTINGS_CHAT_FEATURES);
            }
            this.N = false;
            eibpVar.m();
            eifpVarT.close();
