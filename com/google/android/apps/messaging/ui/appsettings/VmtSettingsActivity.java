...
public final class VmtSettingsActivity extends curi implements ehlg, ehld, ehnq {
    private cvcv L;
    private boolean N;
    private Context O;
    private lvn Q;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof VmtSettingsActivity)) {
                            throw new IllegalStateException(a.L(activity, cvcv.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        VmtSettingsActivity vmtSettingsActivity = (VmtSettingsActivity) activity;
                        vmtSettingsActivity.getClass();
                        this.L = new cvcv(vmtSettingsActivity, Optional.of(((ahhk) objBb).b.a.r()));
                        eieuVarK.close();
    ...
    protected final int C() {
        M();
        return R.layout.vmt_settings_activity_gm3;
    }
    ...
    protected final Integer G() {
        M();
        return Integer.valueOf(R.id.vmt_settings_container);
    }
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            final cvcv cvcvVarM = M();
            Optional optional = cvcvVarM.b;
            final fdap fdapVar = new fdap() { // from class: cvct
                @Override // defpackage.fdap
                public final Object invoke(Object obj) {
                    ((sub) obj).getClass();
                    VmtSettingsActivity vmtSettingsActivity = cvcvVarM.a;
                    vmtSettingsActivity.setTitle(R.string.vmt_preference_page_title);
                    ((TextView) vmtSettingsActivity.findViewById(R.id.vmt_preferences_education)).setText(R.string.vmt_preference_page_education);
                    cg cgVar = new cg(vmtSettingsActivity.a());
                    cvcw cvcwVar = new cvcw();
                    eyhj.e(cvcwVar);
                    cgVar.D(R.id.vmt_preferences_fragment_container, cvcwVar);
                    cgVar.c();
                    return fctx.a;
                }
            };
            optional.ifPresent(new Consumer() { // from class: cvcu
