...
import defpackage.curc;
import defpackage.cvbd;
import defpackage.cvbp;
import defpackage.eehf;
...
public final class SwipeActionSettingsActivity extends curc implements ehlg, ehld, ehnq {
    private cvbd L;
    private boolean N;
    private Context O;
    private lvn Q;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof SwipeActionSettingsActivity)) {
                            throw new IllegalStateException(a.L(activity, cvbd.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        ...
                        this.L = new cvbd(swipeActionSettingsActivity);
                        eieuVarK.close();
    ...
    @Override // defpackage.aiic, defpackage.cukn, defpackage.cukf, defpackage.cukc
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            SwipeActionSettingsActivity swipeActionSettingsActivity = M().a;
            im imVarK = swipeActionSettingsActivity.k();
            if (eehf.b()) {
                swipeActionSettingsActivity.setTheme(R.style.ThemeOverlay_SwipeActionSettingsActivity_DynamicColors_DayNight);
            }
            String string = swipeActionSettingsActivity.getString(R.string.swipe_actions);
            if (!TextUtils.isEmpty(string)) {
                cukg.b(imVarK, string);
            }
            cg cgVar = new cg(swipeActionSettingsActivity.a());
            cvbp cvbpVar = new cvbp();
            eyhj.e(cvbpVar);
            cgVar.D(R.id.fragment_container, cvbpVar);
            cgVar.c();
            this.N = false;
            eibpVar.m();
            eifpVarT.close();
