...
public final class SpamSettingsActivity extends cuqz implements ehlg, ehld, ehnq {
    private cvau L;
    private boolean N;
    private Context O;
    private lvn Q;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof SpamSettingsActivity)) {
                            throw new IllegalStateException(a.L(activity, cvau.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        SpamSettingsActivity spamSettingsActivity = (SpamSettingsActivity) activity;
                        spamSettingsActivity.getClass();
                        this.L = new cvau(spamSettingsActivity, (aijh) ((ahhk) objBb).b.a.Uk.b(), (achu) ((ahhk) objBb).c.bA.b(), ((ahhk) objBb).aW);
                        eieuVarK.close();
    ...
    protected final int C() {
        M();
        return R.layout.spam_settings_activity_gm3_v2;
    }
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            final cvau cvauVarM = M();
            SpamSettingsActivity spamSettingsActivity = cvauVarM.a;
            spamSettingsActivity.getWindow().setStatusBarColor(0);
            TextView textView = (TextView) spamSettingsActivity.findViewById(R.id.spam_preference_fragment_container_text_view);
            if (crxi.a()) {
                textView.setVisibility(8);
            } else {
                textView.setOnClickListener(new View.OnClickListener() { // from class: cvat
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        String str = (String) cvfm.b.e();
                        String str2 = (String) cvfm.a.e();
                        if (TextUtils.isEmpty(str) && TextUtils.isEmpty(str2)) {
                            return;
                        }
                        cvau cvauVar = cvauVarM;
                        if (crtr.d()) {
                            ((aise) cvauVar.d.b()).c(2, 3);
                        }
                        if (TextUtils.isEmpty(str)) {
                            cvauVar.b.t(cvauVar.a, str2);
                        } else {
                            cvauVar.c.d(cvauVar.a, str);
                        }
                    }
                });
                SpannableStringBuilder spannableStringBuilderD = dajs.d(spamSettingsActivity, R.string.spam_protection_consent_string);
                textView.setText(spannableStringBuilderD);
                textView.setContentDescription(spannableStringBuilderD.toString());
            }
            cg cgVar = new cg(spamSettingsActivity.a());
            if (crxi.a()) {
                cczi ccziVar = cvfm.a;
                cvev cvevVar = new cvev();
                eyhj.e(cvevVar);
                cgVar.D(R.id.spam_preference_fragment_container, cvevVar);
            } else {
                cvav cvavVar = new cvav();
                eyhj.e(cvavVar);
                cgVar.D(R.id.spam_preference_fragment_container, cvavVar);
            }
            if (csje.a()) {
                cczi ccziVar2 = cvfu.a;
                cvfn cvfnVar = new cvfn();
                eyhj.e(cvfnVar);
                cgVar.D(R.id.cross_country_preference_fragment_container, cvfnVar);
            } else {
                View viewFindViewById = spamSettingsActivity.findViewById(R.id.cross_country_preference_fragment_container);
