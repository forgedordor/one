...
public final class SimSelectionSettingsActivity extends cuqu implements ehlg, ehld, ehnq {
    private cuyx L;
    private boolean N;
    private Context O;
    private lvn Q;
        ...
        if (this.L == null) {
            ...
            try {
                ...
                try {
                    try {
                        Object objBb = bb();
                        this.L = new cuyx(((ahhk) objBb).aY, ((ahhk) objBb).x, ((ahhk) objBb).y);
                        eieuVarK.close();
