...
import defpackage.cuqh;
import defpackage.cuse;
import defpackage.cusf;
...
public final class NudgeSettingsActivity extends cuqh implements ehlg, ehld, ehnq {
    private cuse L;
    private boolean N;
    private Context O;
    private lvn Q;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof NudgeSettingsActivity)) {
                            throw new IllegalStateException(a.L(activity, cuse.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        NudgeSettingsActivity nudgeSettingsActivity = (NudgeSettingsActivity) activity;
                        nudgeSettingsActivity.getClass();
                        this.L = new cuse(nudgeSettingsActivity);
                        eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            cusf cusfVar = new cusf();
            eyhj.e(cusfVar);
            cgVar.D(R.id.fragment_container, cusfVar);
            cgVar.j();
            this.N = false;
            eibpVar.m();
            eifpVarT.close();
