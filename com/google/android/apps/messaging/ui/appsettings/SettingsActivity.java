...
public final class SettingsActivity extends cuqr implements ehlg, ehld, ehnq {
    private boolean I;
    private Context J;
    private lvn L;
    private boolean M;
            ...
            try {
                try {
                    ...
                    if (!(activity instanceof SettingsActivity)) {
                        throw new IllegalStateException(a.L(activity, cuys.class, "Attempt to inject a Activity wrapper of type "));
                    }
                    SettingsActivity settingsActivity = (SettingsActivity) activity;
                    settingsActivity.getClass();
                    ahnh ahnhVar = ((ahhk) objBb).b.a;
                    this.n = new cuys(settingsActivity, (aijh) ahnhVar.Uk.b(), (crny) ahnhVar.pf.b(), ((ahhk) objBb).x, ahnhVar.aow, ((ahhk) objBb).y, Optional.empty());
                    eieuVarK.close();
                    this.n.d = this;
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            SettingsActivity settingsActivity = M().a;
            im imVarK = settingsActivity.k();
            if (imVarK != null) {
