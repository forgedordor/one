...
public final class HqmsSettingsActivity extends cuqf implements ehlg, ehld, ehnq {
    private curp L;
    private boolean N;
    private Context O;
    private lvn Q;
        ...
        try {
            ...
            try {
                try {
                    ...
                    if (!(activity instanceof HqmsSettingsActivity)) {
                        throw new IllegalStateException(a.L(activity, curp.class, "Attempt to inject a Activity wrapper of type "));
                    }
                    HqmsSettingsActivity hqmsSettingsActivity = (HqmsSettingsActivity) activity;
                    hqmsSettingsActivity.getClass();
                    ahnh ahnhVar = ((ahhk) objBb).b.a;
                    this.L = new curp(hqmsSettingsActivity, ahnhVar.Uk, ((ahhk) objBb).aX, ahnhVar.pI, ((ahhk) objBb).y, ((ahhk) objBb).x, ahnhVar.pG);
                    eieuVarK.close();
    ...
    protected final int C() {
        M();
        return R.layout.hqms_settings_activity_gm3;
    }
    ...
    protected final Integer G() {
        M();
        return Integer.valueOf(R.id.hqms_settings_container);
    }
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            final curp curpVarM = M();
            HqmsSettingsActivity hqmsSettingsActivity = curpVarM.a;
            TextView textView = (TextView) hqmsSettingsActivity.findViewById(R.id.hqms_preference_fragment_container_text_view);
            SpannableStringBuilder spannableStringBuilderD = dajs.d(hqmsSettingsActivity, R.string.hqms_settings_info_text);
            textView.setText(spannableStringBuilderD);
            textView.setContentDescription(spannableStringBuilderD.toString());
            textView.setOnClickListener(new View.OnClickListener() { // from class: curk
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    curp curpVar = curpVarM;
                    aijh aijhVar = (aijh) curpVar.b.b();
                    cczv cczvVar = cgwx.a;
                    aijhVar.t(curpVar.a, (String) cgwx.e.e());
                }
            });
            this.N = false;
            eibpVar.m();
