...
public final class ApplicationSettingsActivity extends cuqa implements ehlg, ehld, ehnq {
    private cumf L;
    private boolean N;
    private Context O;
    private lvn Q;
        ...
        try {
            ...
            try {
                try {
                    ...
                    if (!(activity instanceof ApplicationSettingsActivity)) {
                        throw new IllegalStateException(a.L(activity, cumf.class, "Attempt to inject a Activity wrapper of type "));
                    }
                    ApplicationSettingsActivity applicationSettingsActivity = (ApplicationSettingsActivity) activity;
                    applicationSettingsActivity.getClass();
                    ahnh ahnhVar = ((ahhk) objBb).b.a;
                    this.L = new cumf(applicationSettingsActivity, (ains) ahnhVar.c.b(), ((ahhk) objBb).x, ahnhVar.aow, ((ahhk) objBb).y, Optional.empty());
                    eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            cumf cumfVarM = M();
            ApplicationSettingsActivity applicationSettingsActivity = cumfVarM.b;
            im imVarK = applicationSettingsActivity.k();
            if (imVarK != null && applicationSettingsActivity.getIntent().getBooleanExtra("top_level_settings", false)) {
                cukg.c(applicationSettingsActivity, imVarK, R.string.settings_activity_title);
            }
            cumfVarM.a.c("Bugle.UI.Settings.Application");
            this.N = false;
            eibpVar.m();
            eifpVarT.close();
        } catch (Throwable th) {
