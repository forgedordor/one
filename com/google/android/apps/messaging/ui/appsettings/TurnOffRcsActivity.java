...
public final class TurnOffRcsActivity extends curf implements ehlg, ehld, ehnq {
    private boolean M;
    private Context N;
    private lvn P;
    private boolean Q;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof TurnOffRcsActivity)) {
                            throw new IllegalStateException(a.L(activity, cvcd.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        TurnOffRcsActivity turnOffRcsActivity = (TurnOffRcsActivity) activity;
                        turnOffRcsActivity.getClass();
                        this.n = new cvcd(turnOffRcsActivity);
                        eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            M();
            cvcd cvcdVar = this.n;
            cvce cvceVar = new cvce();
            eyhj.e(cvceVar);
            cg cgVar = new cg(cvcdVar.a.a());
            cgVar.s(R.id.content, cvceVar);
            cgVar.c();
            this.M = false;
            eibpVar.m();
            eifpVarT.close();
