...
public final class PerSubscriptionSettingsActivity extends cuqk implements ehlg, ehld, ehnq {
    private cutb L;
    private boolean N;
    private Context O;
    private lvn Q;
            ...
            try {
                try {
                    ...
                    if (!(activity instanceof PerSubscriptionSettingsActivity)) {
                        throw new IllegalStateException(a.L(activity, cutb.class, "Attempt to inject a Activity wrapper of type "));
                    }
                    ...
                    this.L = new cutb(perSubscriptionSettingsActivity, (ains) ahnhVar.c.b(), ((ahhk) objBb).x, ahnhVar.aow, ((ahhk) objBb).y);
                    eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            cutb cutbVarM = M();
            PerSubscriptionSettingsActivity perSubscriptionSettingsActivity = cutbVarM.b;
            im imVarK = perSubscriptionSettingsActivity.k();
            if (imVarK != null) {
                String stringExtra = perSubscriptionSettingsActivity.getIntent().getStringExtra("per_sub_setting_title");
                if (!TextUtils.isEmpty(stringExtra)) {
                    cukg.b(imVarK, stringExtra);
                }
            }
            cutbVarM.a.c("Bugle.UI.Settings.Advanced");
            this.N = false;
            eibpVar.m();
            eifpVarT.close();
        } catch (Throwable th) {
