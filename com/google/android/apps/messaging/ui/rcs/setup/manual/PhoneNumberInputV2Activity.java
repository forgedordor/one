...
import defpackage.czsw;
import defpackage.czto;
import defpackage.cztp;
...
public final class PhoneNumberInputV2Activity extends czsv implements ehlg, ehld, ehnq {
    private boolean I;
    private Context J;
    private lvn L;
    private boolean M;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof PhoneNumberInputV2Activity)) {
                            throw new IllegalStateException(a.L(activity, cztz.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        ...
                        this.n = new cztz(phoneNumberInputV2Activity);
                        eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            cztz cztzVarM = M();
            if (bundle == null) {
                PhoneNumberInputV2Activity phoneNumberInputV2Activity = cztzVarM.a;
                if (phoneNumberInputV2Activity.a().h("phone_number_input_bottom_sheet_fragment_tag") == null) {
                    czto cztoVar = (czto) cztp.a.createBuilder();
                    String string = Integer.toString(phoneNumberInputV2Activity.getIntent().getIntExtra("phone_number_input_ui_event_source_extra_key", 0));
                    cztoVar.copyOnWrite();
                    cztp cztpVar = (cztp) cztoVar.instance;
                    string.getClass();
                    cztpVar.b |= 2;
                    cztpVar.d = string;
                    String stringExtra = phoneNumberInputV2Activity.getIntent().getStringExtra("phone_number_input_ui_event_sim_id_extra_key");
                    if (stringExtra != null) {
                        cztoVar.copyOnWrite();
                        cztp cztpVar2 = (cztp) cztoVar.instance;
                        cztpVar2.b = 1 | cztpVar2.b;
                        cztpVar2.c = stringExtra;
                    }
                    czsw.aY((cztp) cztoVar.build()).t(phoneNumberInputV2Activity.a(), "phone_number_input_bottom_sheet_fragment_tag");
                }
            }
            this.I = false;
            eibpVar.m();
