...
public final class ConversationDetailsActivity extends cvvu implements ehlg, ehld, ehnq {
    private boolean M;
    private Context N;
    private lvn P;
    private boolean Q;
            ...
            try {
                try {
                    ...
                    if (!(activity instanceof ConversationDetailsActivity)) {
                        throw new IllegalStateException(a.L(activity, cvuz.class, "Attempt to inject a Activity wrapper of type "));
                    }
                    ConversationDetailsActivity conversationDetailsActivity = (ConversationDetailsActivity) activity;
                    conversationDetailsActivity.getClass();
                    this.n = new cvuz(conversationDetailsActivity, ((ahhk) objBb).bd, ((ahhk) objBb).be, (efxf) ((ahhk) objBb).x.b(), (egkc) ((ahhk) objBb).b.a.aow.b());
                    eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            cvuz cvuzVar = this.n;
            einf.a(this, agbm.class, new cvva(cvuzVar));
            einf.a(this, agbg.class, new cvvb(cvuzVar));
            einf.a(this, agfd.class, new cvvc(cvuzVar));
            einf.a(this, agfe.class, new cvvd(cvuzVar));
            this.M = false;
            eibpVar.m();
            eifpVarT.close();
        } catch (Throwable th) {
