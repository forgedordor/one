...
public final class ForwardMessageActivity extends cwvk implements ehlg, ehld, ehnq {
    private cwvi n;
    private boolean p;
    private Context q;
    private lvn y;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof ForwardMessageActivity)) {
                            throw new IllegalStateException(a.L(activity, cwvi.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        ...
                        this.n = new cwvi(forwardMessageActivity, ahnhVar.Jm, ahnhVar.BK, ahknVar.b.hT);
                        eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            ForwardMessageActivity forwardMessageActivity = cwviVarJ.a;
            int intExtra = forwardMessageActivity.getIntent().getIntExtra("intent_source", 0);
            Bundle bundle2 = new Bundle(1);
            bundle2.putInt("intent_source", intExtra);
            cwweVarAY.at(bundle2);
            cwweVarAY.t(forwardMessageActivity.a(), "ShareIntentFragment");
            cwviVarJ.c = (MessageCoreData) forwardMessageActivity.getIntent().getParcelableExtra("draft_data");
            cwviVarJ.d = avnt.b(forwardMessageActivity.getIntent());
            this.p = false;
            eibpVar.m();
            eifpVarT.close();
        } catch (Throwable th) {
