...
public final class GaiaDittoActivity extends cysl implements ehlg, ehld, ehnq {
    private boolean M;
    private Context N;
    private lvn P;
    private boolean Q;
        ...
        try {
            ...
            try {
                try {
                    ...
                    if (!(activity instanceof GaiaDittoActivity)) {
                        throw new IllegalStateException(a.L(activity, cyqz.class, "Attempt to inject a Activity wrapper of type "));
                    }
                    GaiaDittoActivity gaiaDittoActivity = (GaiaDittoActivity) activity;
                    gaiaDittoActivity.getClass();
                    eyik eyikVar = ((ahhk) objBb).x;
                    ahkn ahknVar = ((ahhk) objBb).b;
                    ahnh ahnhVar = ahknVar.a;
                    this.n = new cyqz(gaiaDittoActivity, eyikVar, ahnhVar.aow, ((ahhk) objBb).y, ((ahhk) objBb).ac, ahnhVar.pQ, ahnhVar.adE, ahknVar.b.kx, ahnhVar.rK, ahnhVar.rJ, (eosc) ahknVar.p.b());
                    eieuVarK.close();
                    this.n.j = this;
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            M();
            final cyqz cyqzVar = this.n;
            if (((asgn) cyqzVar.e.b()).a()) {
                abl.a(cyqzVar.b);
            }
            if (((aqpb) cyqzVar.h.b()).a()) {
                bvll bvllVar = (bvll) cyqzVar.g.b();
                bvllVar.getClass();
                eiju eijuVarB = bvllVar.b();
                ejvr ejvrVar = new ejvr() { // from class: cyqx
                    @Override // defpackage.ejvr
                    public final Object apply(Object obj) {
                        if (((Boolean) obj).booleanValue()) {
                            return null;
                        }
                        ((ains) cyqzVar.d.b()).e("Bugle.Gaia.Pairing.Can.Device.Register.Failure.Count", 3);
                        return null;
                    }
                };
                eosc eoscVar = cyqzVar.i;
                eijuVarB.h(ejvrVar, eoscVar).k(auvh.b(), eoscVar);
            }
            cyqzVar.b.setContentView(true != ((asgq) cyqzVar.f.b()).a() ? R.layout.gaia_ditto_activity : R.layout.gaia_ditto_activity_coolranch);
            if (bundle == null) {
                ((ains) cyqzVar.d.b()).c("Bugle.Gaia.Pairing.Seen");
            }
            this.M = false;
            eibpVar.m();
            eifpVarT.close();
