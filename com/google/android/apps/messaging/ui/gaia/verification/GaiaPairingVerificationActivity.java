package com.google.android.apps.messaging.ui.gaia.verification;
...
import defpackage.cysz;
import defpackage.cytb;
...
public final class GaiaPairingVerificationActivity extends cyts implements ehlg, ehld, ehnq {
    private cysz n;
    private boolean p;
    private Context q;
    private lvn y;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof GaiaPairingVerificationActivity)) {
                            throw new IllegalStateException(a.L(activity, cysz.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        GaiaPairingVerificationActivity gaiaPairingVerificationActivity = (GaiaPairingVerificationActivity) activity;
                        gaiaPairingVerificationActivity.getClass();
                        ahnh ahnhVar = ((ahhk) objBb).b.a;
                        this.n = new cysz(gaiaPairingVerificationActivity, ahnhVar.Yc, Optional.of((bvqv) ahnhVar.Yb.b()));
                        eieuVarK.close();
    ...
    /* JADX WARN: Type inference failed for: r10v15, types: [bvqv, java.lang.Object] */
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            cysz cyszVarJ = J();
            GaiaPairingVerificationActivity gaiaPairingVerificationActivity = cyszVarJ.b;
            cg cgVar = new cg(gaiaPairingVerificationActivity.a());
            cytb cytbVar = new cytb();
            eyhj.e(cytbVar);
            cgVar.s(R.id.content, cytbVar);
            cgVar.c();
            if (bundle == null) {
                eksp ekspVar = cysz.a;
                eksl ekslVar = (eksl) ekspVar.h();
                ekrz ekrzVar = cqnc.S;
                ekslVar.X(ekrzVar, cyszVarJ.getClass().getSimpleName());
                ekslVar.q("Gaia pairing verification prompt created");
                int intExtra = gaiaPairingVerificationActivity.getIntent().getIntExtra("prompt_launch_source", 0);
                eksl ekslVar2 = (eksl) ekspVar.h();
                ekslVar2.X(ekrzVar, cyszVarJ.getClass().getSimpleName());
                ekslVar2.r("launch source: %s", intExtra);
                bvsh bvshVar = (bvsh) cyszVarJ.c.b();
                if (intExtra != 0) {
                    i = 3;
                    if (intExtra != 1) {
                        i = intExtra != 2 ? intExtra != 3 ? 0 : 5 : 4;
                    }
                } else {
                    i = 2;
                }
                if (bvshVar.d.a()) {
                    auvw.c(bvshVar.e, fcyi.a, fdjz.a, new bvsf(bvshVar, i, null));
                } else {
                    ((bvio) bvshVar.a.b()).x(2, (String) ((cecr) bvshVar.b.b()).a.get(), i);
                }
                Optional optional = cyszVarJ.d;
                optional.isPresent();
                optional.get().k();
            }
            this.p = false;
