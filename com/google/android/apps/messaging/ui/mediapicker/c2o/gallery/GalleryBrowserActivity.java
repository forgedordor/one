...
public final class GalleryBrowserActivity extends czaq implements ehlg, ehld, ehnq {
    private cyzp K;
    private boolean M;
    private Context N;
    private lvn P;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof GalleryBrowserActivity)) {
                            throw new IllegalStateException(a.L(activity, cyzp.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        GalleryBrowserActivity galleryBrowserActivity = (GalleryBrowserActivity) activity;
                        galleryBrowserActivity.getClass();
                        this.K = new cyzp(galleryBrowserActivity, (efxf) ((ahhk) objBb).x.b(), ((ahhk) objBb).y);
                        eieuVarK.close();
                        this.K.c = this;
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            cyzp cyzpVarAh = ah();
            cyzpVarAh.b = new cyzo(cyzpVarAh);
            GalleryBrowserActivity galleryBrowserActivity = cyzpVarAh.a;
            galleryBrowserActivity.c().b(galleryBrowserActivity, cyzpVarAh.b);
            einc.a(this).b = findViewById(R.id.content);
            einf.a(this, cyzj.a.class, new cyzq(this.K));
            this.M = false;
            eibpVar.m();
            eifpVarT.close();
        } catch (Throwable th) {
    ...
    public final boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        try {
            cyzp cyzpVarAh = ah();
            GalleryBrowserActivity galleryBrowserActivity = cyzpVarAh.a;
            ActionMode actionMode = (ActionMode) galleryBrowserActivity.V().orElse(null);
            ActionMode.Callback callbackQ = galleryBrowserActivity.Q();
            boolean zOnOptionsItemSelected = (actionMode == null || callbackQ == null || !callbackQ.onActionItemClicked(actionMode, menuItem)) ? super.onOptionsItemSelected(menuItem) : true;
            eifpVarW.close();
