package com.google.android.apps.messaging.analytics.consent;
...
public final class LoggingConsentSettingsActivity extends sqz implements ehlg, ehld, ehnq {
    private srg L;
    private boolean N;
    private Context O;
    private lvn Q;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof LoggingConsentSettingsActivity)) {
                            throw new IllegalStateException(a.L(activity, srg.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        LoggingConsentSettingsActivity loggingConsentSettingsActivity = (LoggingConsentSettingsActivity) activity;
                        loggingConsentSettingsActivity.getClass();
                        this.L = new srg(loggingConsentSettingsActivity);
                        eieuVarK.close();
    ...
    protected final int C() {
        M();
        return R.layout.logging_consent_activity;
    }
    ...
    protected final Integer G() {
        M();
        return Integer.valueOf(R.id.logging_consent_settings_container);
    }
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            srh srhVar = new srh();
            eyhj.e(srhVar);
            cgVar.D(R.id.logging_consent_preference_fragment_container, srhVar);
            cgVar.c();
            this.N = false;
            eibpVar.m();
            eifpVarT.close();
