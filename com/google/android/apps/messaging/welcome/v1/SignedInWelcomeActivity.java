package com.google.android.apps.messaging.welcome.v1;
...
public final class SignedInWelcomeActivity extends datj implements ehlg, ehld, ehnq {
    private datm n;
    private boolean p;
    private Context q;
    private lvn y;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof SignedInWelcomeActivity)) {
                            throw new IllegalStateException(a.L(activity, datm.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        SignedInWelcomeActivity signedInWelcomeActivity = (SignedInWelcomeActivity) activity;
                        signedInWelcomeActivity.getClass();
                        this.n = new datm(eyikVar, signedInWelcomeActivity, ((ahhk) objBb).y, ((ahhk) objBb).b.a.adE);
                        eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            datm datmVarJ = J();
            if (((asgn) datmVarJ.b.b()).a()) {
                abl.a(datmVarJ.a);
            }
            SignedInWelcomeActivity signedInWelcomeActivity = datmVarJ.a;
            Intent intent = signedInWelcomeActivity.getIntent();
            intent.getClass();
            if (daug.a(intent) != ctcj.WELCOME_FLOW_SETTINGS) {
                signedInWelcomeActivity.c().a(new datl(datmVarJ));
            }
            this.p = false;
            eibpVar.m();
            eifpVarT.close();
