...
public final class StartChatActivity extends cthw implements ehlg, ehld, ehnq {
    private boolean M;
    private Context N;
    private lvn P;
    private boolean Q;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof StartChatActivity)) {
                            throw new IllegalStateException(a.L(activity, cthy.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        StartChatActivity startChatActivity = (StartChatActivity) activity;
                        startChatActivity.getClass();
                        this.n = new cthy(startChatActivity, ((ahhk) objBb).x, ((ahhk) objBb).y);
                        eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            einf.a(this, agbg.class, new cthz(this.n));
            this.M = false;
            eibpVar.m();
            eifpVarT.close();
        } catch (Throwable th) {
