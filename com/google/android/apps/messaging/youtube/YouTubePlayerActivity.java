...
public final class YouTubePlayerActivity extends dbad implements ehlg, ehld, ehnq {
    private dbao o;
    private boolean q;
    private Context r;
    private lvn t;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof YouTubePlayerActivity)) {
                            throw new IllegalStateException(a.L(activity, dbao.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        YouTubePlayerActivity youTubePlayerActivity = (YouTubePlayerActivity) activity;
                        youTubePlayerActivity.getClass();
                        this.o = new dbao(youTubePlayerActivity, ((ahhk) objBb).x, ((ahhk) objBb).y);
                        eieuVarK.close();
    ...
    @Override // defpackage.dbad, defpackage.ecdl, defpackage.eg, defpackage.abi, defpackage.hl, android.app.Activity
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            E();
            this.o.a.setContentView(R.layout.youtube_player_activity);
            this.q = false;
            eibpVar.m();
            eifpVarT.close();
        } catch (Throwable th) {
    ...
    @Override // defpackage.dbad, defpackage.ecdl, defpackage.iy, defpackage.eg, android.app.Activity
