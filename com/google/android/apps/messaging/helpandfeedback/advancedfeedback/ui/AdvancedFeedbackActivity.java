...
public final class AdvancedFeedbackActivity extends acmm implements ehlg, ehld, ehnq {
    private boolean M;
    private Context N;
    private lvn P;
    private boolean Q;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof AdvancedFeedbackActivity)) {
                            throw new IllegalStateException(a.L(activity, ackz.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        AdvancedFeedbackActivity advancedFeedbackActivity = (AdvancedFeedbackActivity) activity;
                        advancedFeedbackActivity.getClass();
                        this.n = new ackz(advancedFeedbackActivity);
                        eieuVarK.close();
                        this.n.e = this;
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            ackz ackzVarM = M();
            AdvancedFeedbackActivity advancedFeedbackActivity = ackzVarM.a;
            ...
            if (extras != null && (str = (String) extras.get("advanced_feedback_screenshot_key")) != null) {
                ackzVarM.b = new File(str);
            }
            if (bundle == null) {
                cg cgVar = new cg(advancedFeedbackActivity.a());
                File file = ackzVarM.b;
                ...
                cgVar.s(R.id.advanced_feedback_fragment_container, acljVarA);
                cgVar.A();
                cgVar.c();
            } else {
                ackzVarM.d = new int[]{1, 2, 3}[bundle.getInt("current_ui_state")];
            }
            ackzVarM.c = new acky(ackzVarM);
            advancedFeedbackActivity.c().b(advancedFeedbackActivity, ackzVarM.c);
            einc.a(this).b = findViewById(android.R.id.content);
            ackz ackzVar = this.n;
            einf.a(this, acmk.class, new acla(ackzVar));
            einf.a(this, acmj.class, new aclb(ackzVar));
            einf.a(this, acmu.class, new aclc(ackzVar));
            this.M = false;
            eibpVar.m();
            eifpVarT.close();
        } catch (Throwable th) {
