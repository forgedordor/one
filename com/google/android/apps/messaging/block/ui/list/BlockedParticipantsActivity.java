package com.google.android.apps.messaging.block.ui.list;
...
public final class BlockedParticipantsActivity extends tgf implements ehlg, ehld, ehnq {
    private boolean I;
    private Context J;
    private lvn L;
    private boolean M;
    private tgb n;
    private final eibp H = new eibp(this, this);
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            tgg tggVar = new tgg();
            eyhj.e(tggVar);
            fcsu fcsuVar = tgbVarM.a;
            cg cgVar = new cg(((BlockedParticipantsActivity) fcsuVar.b()).a());
            cgVar.s(R.id.content, tggVar);
            cgVar.c();
            im imVarK = ((BlockedParticipantsActivity) fcsuVar.b()).k();
            if (imVarK != null) {
                imVarK.setDisplayHomeAsUpEnabled(true);
                imVarK.setTitle(com.google.android.apps.messaging.R.string.blocked_destination_list_title);
            }
            this.I = false;
            eibpVar.m();
            eifpVarT.close();
    ...
    public final boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        try {
            ...
            if (menuItem.getItemId() != 16908332) {
                ...
                ((BlockedParticipantsActivity) tgbVarM.a.b()).c().d();
                z = true;
            }
            eifpVarW.close();
            return z;
