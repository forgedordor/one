package com.google.android.apps.messaging.suggestions.settings;
...
public final class SmartActionSettingsActivity extends cufv implements ehlg, ehld, ehnq {
    private cufx L;
    private boolean N;
    private Context O;
    private lvn Q;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof SmartActionSettingsActivity)) {
                            throw new IllegalStateException(a.L(activity, cufx.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        SmartActionSettingsActivity smartActionSettingsActivity = (SmartActionSettingsActivity) activity;
                        smartActionSettingsActivity.getClass();
                        this.L = new cufx(smartActionSettingsActivity);
                        eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            cufy cufyVar = new cufy();
            eyhj.e(cufyVar);
            cgVar.D(R.id.fragment_container, cufyVar);
            cgVar.c();
            this.N = false;
            eibpVar.m();
            eifpVarT.close();
