package com.google.android.apps.messaging.penpal.settings;
...
public final class GeminiSettingsActivity extends agxi implements ehlg, ehld, ehnq {
    private agxa L;
    private boolean N;
    private Context O;
    private lvn Q;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof GeminiSettingsActivity)) {
                            throw new IllegalStateException(a.L(activity, agxa.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        GeminiSettingsActivity geminiSettingsActivity = (GeminiSettingsActivity) activity;
                        geminiSettingsActivity.getClass();
                        this.L = new agxa(geminiSettingsActivity);
                        eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            GeminiSettingsActivity geminiSettingsActivity = M().a;
            cg cgVar = new cg(geminiSettingsActivity.a());
            geminiSettingsActivity.setTitle(geminiSettingsActivity.getString(R.string.gemini_settings_page_title));
            agxb agxbVar = new agxb();
            eyhj.e(agxbVar);
            cgVar.D(R.id.fragment_container, agxbVar);
            cgVar.c();
            this.N = false;
            eibpVar.m();
            eifpVarT.close();
