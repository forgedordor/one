package com.google.android.apps.messaging.notifications.settings;
...
public final class NotificationSettingsActivity extends agjr implements ehlg, ehld, ehnq {
    private agjt L;
    private boolean N;
    private Context O;
    private lvn Q;
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof NotificationSettingsActivity)) {
                            throw new IllegalStateException(a.L(activity, agjt.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        NotificationSettingsActivity notificationSettingsActivity = (NotificationSettingsActivity) activity;
                        notificationSettingsActivity.getClass();
                        this.L = new agjt(notificationSettingsActivity);
                        eieuVarK.close();
    ...
    protected final int C() {
        M();
        return R.layout.notification_settings_activity_gm3;
    }
    ...
    protected final Integer G() {
        M();
        return Integer.valueOf(R.id.notification_preference_fragment_container);
    }
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            NotificationSettingsActivity notificationSettingsActivity = M().a;
            notificationSettingsActivity.getWindow().setStatusBarColor(0);
            cg cgVar = new cg(notificationSettingsActivity.a());
            agju agjuVar = new agju();
            eyhj.e(agjuVar);
            cgVar.D(R.id.notification_preference_fragment_container, agjuVar);
            cgVar.c();
            this.N = false;
            eibpVar.m();
            eifpVarT.close();
