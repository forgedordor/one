...
public final class JoinViaLinkActivity extends adjy implements ehlg, ehld, ehnq {
    private Context M;
    private lvn O;
    private boolean P;
    private adka n;
    ...
    /* JADX WARN: Type inference failed for: r1v3, types: [ehoa, java.lang.Object] */
                ...
                try {
                    ...
                    try {
                        try {
                            ...
                            if (!(activity instanceof JoinViaLinkActivity)) {
                                throw new IllegalStateException(a.L(activity, adka.class, "Attempt to inject a Activity wrapper of type "));
                            }
                            JoinViaLinkActivity joinViaLinkActivity = (JoinViaLinkActivity) activity;
                            joinViaLinkActivity.getClass();
                            this.n = new adka(joinViaLinkActivity, ((ahhk) objBb).x, ((ahhk) objBb).y);
                            eieuVarK.close();
                        } finally {
                        }
