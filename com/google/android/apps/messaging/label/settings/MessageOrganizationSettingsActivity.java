package com.google.android.apps.messaging.label.settings;
...
public final class MessageOrganizationSettingsActivity extends afdh implements ehlg, ehld, ehnq {
    private afdn L;
    private boolean N;
    private Context O;
    private lvn Q;
            ...
            try {
                ...
                try {
                    try {
                        ...
                        if (!(activity instanceof MessageOrganizationSettingsActivity)) {
                            throw new IllegalStateException(a.L(activity, afdn.class, "Attempt to inject a Activity wrapper of type "));
                        }
                        MessageOrganizationSettingsActivity messageOrganizationSettingsActivity = (MessageOrganizationSettingsActivity) activity;
                        messageOrganizationSettingsActivity.getClass();
                        this.L = new afdn(messageOrganizationSettingsActivity);
                        eieuVarK.close();
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            eyhj.e(afdpVar);
            cgVar.D(R.id.fragment_container, afdpVar);
            cgVar.c();
            this.N = false;
            eibpVar.m();
            eifpVarT.close();
