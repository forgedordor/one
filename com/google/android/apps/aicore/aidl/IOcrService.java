...
public interface IOcrService extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements IOcrService {
        ...
        public static class Proxy extends BaseProxy implements IOcrService {
            ...
            @Override // com.google.android.apps.aicore.aidl.IOcrService
            public ICancellationCallback runCancellableInference(siy siyVar, IOcrResultCallback iOcrResultCallback) {
                Parcel parcelObtainAndWriteInterfaceToken = obtainAndWriteInterfaceToken();
                sgh.d(parcelObtainAndWriteInterfaceToken, siyVar);
                sgh.f(parcelObtainAndWriteInterfaceToken, iOcrResultCallback);
        ...
        public static IOcrService asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface("com.google.android.apps.aicore.aidl.IOcrService");
        ...
        protected boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) {
            if (i == 2) {
                siy siyVar = (siy) sgh.a(parcel, siy.CREATOR);
                IOcrResultCallback iOcrResultCallbackAsInterface = IOcrResultCallback.Stub.asInterface(parcel.readStrongBinder());
                enforceNoDataAvail(parcel);
                ICancellationCallback iCancellationCallbackRunCancellableInference = runCancellableInference(siyVar, iOcrResultCallbackAsInterface);
    ...
    ICancellationCallback runCancellableInference(siy siyVar, IOcrResultCallback iOcrResultCallback);
}
