...
public interface ISonnyService extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements ISonnyService {
        ...
        public static class Proxy extends BaseProxy implements ISonnyService {
            ...
            @Override // com.google.android.apps.aicore.aidl.ISonnyService
            public ICancellationCallback runCancellableInference(skk skkVar, ISonnyResultCallback iSonnyResultCallback) {
                Parcel parcelObtainAndWriteInterfaceToken = obtainAndWriteInterfaceToken();
                sgh.d(parcelObtainAndWriteInterfaceToken, skkVar);
                sgh.f(parcelObtainAndWriteInterfaceToken, iSonnyResultCallback);
        ...
        public static ISonnyService asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface("com.google.android.apps.aicore.aidl.ISonnyService");
        ...
        protected boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) {
            if (i == 2) {
                skk skkVar = (skk) sgh.a(parcel, skk.CREATOR);
                ISonnyResultCallback iSonnyResultCallbackAsInterface = ISonnyResultCallback.Stub.asInterface(parcel.readStrongBinder());
                enforceNoDataAvail(parcel);
                ICancellationCallback iCancellationCallbackRunCancellableInference = runCancellableInference(skkVar, iSonnyResultCallbackAsInterface);
    ...
    ICancellationCallback runCancellableInference(skk skkVar, ISonnyResultCallback iSonnyResultCallback);
}
