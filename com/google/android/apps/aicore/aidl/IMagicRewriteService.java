...
public interface IMagicRewriteService extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements IMagicRewriteService {
        ...
        public static class Proxy extends BaseProxy implements IMagicRewriteService {
            ...
            @Override // com.google.android.apps.aicore.aidl.IMagicRewriteService
            public ICancellationCallback getTokenInfo(siu siuVar, boolean z, ITokenizationCallback iTokenizationCallback) {
                Parcel parcelObtainAndWriteInterfaceToken = obtainAndWriteInterfaceToken();
                sgh.d(parcelObtainAndWriteInterfaceToken, siuVar);
            ...
            @Override // com.google.android.apps.aicore.aidl.IMagicRewriteService
            public ICancellationCallback runCancellableInference(siu siuVar, IMagicRewriteResultCallback iMagicRewriteResultCallback) {
                Parcel parcelObtainAndWriteInterfaceToken = obtainAndWriteInterfaceToken();
                sgh.d(parcelObtainAndWriteInterfaceToken, siuVar);
                sgh.f(parcelObtainAndWriteInterfaceToken, iMagicRewriteResultCallback);
            ...
            @Override // com.google.android.apps.aicore.aidl.IMagicRewriteService
            public ICancellationCallback runCancellableInferenceWithInfo(siu siuVar, IMagicRewriteResultWithInfoCallback iMagicRewriteResultWithInfoCallback) {
                Parcel parcelObtainAndWriteInterfaceToken = obtainAndWriteInterfaceToken();
                sgh.d(parcelObtainAndWriteInterfaceToken, siuVar);
                sgh.f(parcelObtainAndWriteInterfaceToken, iMagicRewriteResultWithInfoCallback);
        ...
        public static IMagicRewriteService asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface("com.google.android.apps.aicore.aidl.IMagicRewriteService");
        ...
        protected boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) {
            if (i == 2) {
                siu siuVar = (siu) sgh.a(parcel, siu.CREATOR);
                ...
                ICancellationCallback iCancellationCallbackRunCancellableInference = runCancellableInference(siuVar, iMagicRewriteResultCallbackAsInterface);
            ...
            if (i == 5) {
                siu siuVar2 = (siu) sgh.a(parcel, siu.CREATOR);
                ...
                enforceNoDataAvail(parcel);
                ICancellationCallback iCancellationCallbackRunCancellableInferenceWithInfo = runCancellableInferenceWithInfo(siuVar2, iMagicRewriteResultWithInfoCallbackAsInterface);
                parcel2.writeNoException();
            ...
            siu siuVar3 = (siu) sgh.a(parcel, siu.CREATOR);
            ...
            enforceNoDataAvail(parcel);
            ICancellationCallback tokenInfo = getTokenInfo(siuVar3, zG, iTokenizationCallbackAsInterface);
            parcel2.writeNoException();
    ...
    ICancellationCallback getTokenInfo(siu siuVar, boolean z, ITokenizationCallback iTokenizationCallback);

    ICancellationCallback prepareInferenceEngine(IPrepareInferenceEngineCallback iPrepareInferenceEngineCallback);

    ICancellationCallback runCancellableInference(siu siuVar, IMagicRewriteResultCallback iMagicRewriteResultCallback);

    ICancellationCallback runCancellableInferenceWithInfo(siu siuVar, IMagicRewriteResultWithInfoCallback iMagicRewriteResultWithInfoCallback);
}
