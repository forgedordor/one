...
public interface ITextClassificationService extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements ITextClassificationService {
        ...
        public static class Proxy extends BaseProxy implements ITextClassificationService {
            ...
            @Override // com.google.android.apps.aicore.aidl.ITextClassificationService
            public ICancellationCallback runCancellableInference(slm slmVar, ITextClassificationResultCallback iTextClassificationResultCallback) {
                Parcel parcelObtainAndWriteInterfaceToken = obtainAndWriteInterfaceToken();
                sgh.d(parcelObtainAndWriteInterfaceToken, slmVar);
                sgh.f(parcelObtainAndWriteInterfaceToken, iTextClassificationResultCallback);
        ...
        public static ITextClassificationService asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface("com.google.android.apps.aicore.aidl.ITextClassificationService");
        ...
        protected boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) {
            if (i == 2) {
                slm slmVar = (slm) sgh.a(parcel, slm.CREATOR);
                ...
                ICancellationCallback iCancellationCallbackRunCancellableInference = runCancellableInference(slmVar, iTextClassificationResultCallbackAsInterface);
    ...
    ICancellationCallback runCancellableInference(slm slmVar, ITextClassificationResultCallback iTextClassificationResultCallback);
}
