...
public final class PolylineOptions extends AbstractSafeParcelable {
    public static final Parcelable.Creator<PolylineOptions> CREATOR = new ddrv();
    public final List a;
    public float b;
    public int c;
    public float d;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        dclw.k(parcel, 9, this.j.a(), i, false);
        dclw.k(parcel, 10, this.k.a(), i, false);
        dclw.i(parcel, 11, this.h);
        dclw.n(parcel, 12, this.i, false);
        ...
        for (StyleSpan styleSpan : this.l) {
            ...
            arrayList.add(new StyleSpan(new StrokeStyle(this.b, iIntValue, iIntValue2, this.e, strokeStyle.e), styleSpan.b));
        }
        dclw.n(parcel, 13, arrayList, false);
        dclw.c(parcel, iA);
    }
