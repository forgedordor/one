    ...
    public static abstract class Stub extends BaseStub implements IOnStreetViewPanoramaChangeListener {
        ...
        public static class Proxy extends BaseProxy implements IOnStreetViewPanoramaChangeListener {
            ...
            public void onStreetViewPanoramaChange(StreetViewPanoramaLocation streetViewPanoramaLocation) {
                ...
                sgh.d(parcelObtainAndWriteInterfaceToken, streetViewPanoramaLocation);
        ...
        public static IOnStreetViewPanoramaChangeListener asInterface(IBinder iBinder) {
            ...
            return iInterfaceQueryLocalInterface instanceof IOnStreetViewPanoramaChangeListener ? (IOnStreetViewPanoramaChangeListener) iInterfaceQueryLocalInterface : new Proxy(iBinder);
        }
        ...
        protected boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            StreetViewPanoramaLocation streetViewPanoramaLocation = (StreetViewPanoramaLocation) sgh.a(parcel, StreetViewPanoramaLocation.CREATOR);
