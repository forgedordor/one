    ...
    public static abstract class Stub extends BaseStub implements IRegisterResponseHandler {
        ...
        public static class Proxy extends BaseProxy implements IRegisterResponseHandler {
            ...
            public void onSuccess(RegisterResponseData registerResponseData) {
                Parcel parcelObtainAndWriteInterfaceToken = obtainAndWriteInterfaceToken();
                sgh.d(parcelObtainAndWriteInterfaceToken, registerResponseData);
        ...
        public static IRegisterResponseHandler asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.fido.u2f.api.IRegisterResponseHandler");
            return iInterfaceQueryLocalInterface instanceof IRegisterResponseHandler ? (IRegisterResponseHandler) iInterfaceQueryLocalInterface : new Proxy(iBinder);
        }
        ...
        protected boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) {
            if (i == 1) {
                ...
                RegisterResponseData registerResponseData = (RegisterResponseData) sgh.a(parcel, RegisterResponseData.CREATOR);
                enforceNoDataAvail(parcel);
