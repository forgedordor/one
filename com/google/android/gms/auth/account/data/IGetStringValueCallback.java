...
public interface IGetStringValueCallback extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements IGetStringValueCallback {
        ...
        public static IGetStringValueCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.auth.account.data.IGetStringValueCallback");
            return iInterfaceQueryLocalInterface instanceof IGetStringValueCallback ? (IGetStringValueCallback) iInterfaceQueryLocalInterface : new Proxy(iBinder);
        }
