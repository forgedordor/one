...
public interface IGetAccountIdCallback extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements IGetAccountIdCallback {
        ...
        public static IGetAccountIdCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.auth.account.data.IGetAccountIdCallback");
            return iInterfaceQueryLocalInterface instanceof IGetAccountIdCallback ? (IGetAccountIdCallback) iInterfaceQueryLocalInterface : new Proxy(iBinder);
        }
