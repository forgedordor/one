...
public interface IAggregateOneTapZuulOptOutStateCallback extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements IAggregateOneTapZuulOptOutStateCallback {
        ...
        public static IAggregateOneTapZuulOptOutStateCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.auth.api.identity.internal.IAggregateOneTapZuulOptOutStateCallback");
            return iInterfaceQueryLocalInterface instanceof IAggregateOneTapZuulOptOutStateCallback ? (IAggregateOneTapZuulOptOutStateCallback) iInterfaceQueryLocalInterface : new Proxy(iBinder);
        }
