...
public interface IIsAutoSelectEnabledForAppCallback extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements IIsAutoSelectEnabledForAppCallback {
        ...
        public static IIsAutoSelectEnabledForAppCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.auth.api.identity.internal.IIsAutoSelectEnabledForAppCallback");
            return iInterfaceQueryLocalInterface instanceof IIsAutoSelectEnabledForAppCallback ? (IIsAutoSelectEnabledForAppCallback) iInterfaceQueryLocalInterface : new Proxy(iBinder);
        }
