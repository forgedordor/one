...
public interface IGetSignInIntentCallback extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements IGetSignInIntentCallback {
        ...
        public static IGetSignInIntentCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.auth.api.identity.internal.IGetSignInIntentCallback");
            return iInterfaceQueryLocalInterface instanceof IGetSignInIntentCallback ? (IGetSignInIntentCallback) iInterfaceQueryLocalInterface : new Proxy(iBinder);
        }
