...
public interface ISortAccountsByLastUsedForCreatePasswordPasskeyCallback extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements ISortAccountsByLastUsedForCreatePasswordPasskeyCallback {
        ...
        public static ISortAccountsByLastUsedForCreatePasswordPasskeyCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.auth.api.identity.internal.ISortAccountsByLastUsedForCreatePasswordPasskeyCallback");
            return iInterfaceQueryLocalInterface instanceof ISortAccountsByLastUsedForCreatePasswordPasskeyCallback ? (ISortAccountsByLastUsedForCreatePasswordPasskeyCallback) iInterfaceQueryLocalInterface : new Proxy(iBinder);
        }
