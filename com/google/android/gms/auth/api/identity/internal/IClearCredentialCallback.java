...
public interface IClearCredentialCallback extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements IClearCredentialCallback {
        ...
        public static IClearCredentialCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.auth.api.identity.internal.IClearCredentialCallback");
            return iInterfaceQueryLocalInterface instanceof IClearCredentialCallback ? (IClearCredentialCallback) iInterfaceQueryLocalInterface : new Proxy(iBinder);
        }
