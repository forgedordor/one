...
public interface IIsOptedInForAutoSelectCallback extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements IIsOptedInForAutoSelectCallback {
        ...
        public static IIsOptedInForAutoSelectCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.auth.api.identity.internal.IIsOptedInForAutoSelectCallback");
            return iInterfaceQueryLocalInterface instanceof IIsOptedInForAutoSelectCallback ? (IIsOptedInForAutoSelectCallback) iInterfaceQueryLocalInterface : new Proxy(iBinder);
        }
