...
public interface IKeyRetrievalConsentCallback extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements IKeyRetrievalConsentCallback {
        ...
        public static class Proxy extends BaseProxy implements IKeyRetrievalConsentCallback {
            ...
            public void onConsentResult(Status status, boolean z, ApiMetadata apiMetadata) {
        ...
        public static IKeyRetrievalConsentCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.auth.folsom.internal.IKeyRetrievalConsentCallback");
            return iInterfaceQueryLocalInterface instanceof IKeyRetrievalConsentCallback ? (IKeyRetrievalConsentCallback) iInterfaceQueryLocalInterface : new Proxy(iBinder);
        }
        ...
        protected boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            onConsentResult(status, zG, apiMetadata);
            return true;
        }
    }

    void onConsentResult(Status status, boolean z, ApiMetadata apiMetadata);
}
