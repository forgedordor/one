...
public class DeviceFilter extends AbstractSafeParcelable {
    public static final Parcelable.Creator<DeviceFilter> CREATOR = new dbvz();
    final Boolean a;
    final Boolean b;
    final Boolean c;
    final List d;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        dclw.o(parcel, 1, this.a);
        dclw.o(parcel, 2, this.b);
        dclw.o(parcel, 3, this.c);
        dclw.D(parcel, 4, this.d);
        dclw.o(parcel, 5, this.e);
        dclw.o(parcel, 6, this.f);
