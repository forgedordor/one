    ...
    public static abstract class Stub extends BaseStub implements ISettingsCallbacks {
        ...
        public static class Proxy extends BaseProxy implements ISettingsCallbacks {
            ...
            public void onCheckLocationSettingsResult(LocationSettingsResult locationSettingsResult) {
                ...
                sgh.d(parcelObtainAndWriteInterfaceToken, locationSettingsResult);
        ...
        public static ISettingsCallbacks asInterface(IBinder iBinder) {
            ...
            return iInterfaceQueryLocalInterface instanceof ISettingsCallbacks ? (ISettingsCallbacks) iInterfaceQueryLocalInterface : new Proxy(iBinder);
        }
        ...
        protected boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            LocationSettingsResult locationSettingsResult = (LocationSettingsResult) sgh.a(parcel, LocationSettingsResult.CREATOR);
