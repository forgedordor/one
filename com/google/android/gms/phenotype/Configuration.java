...
public class Configuration extends AbstractSafeParcelable implements Comparable<Configuration> {
    public static final Parcelable.Creator<Configuration> CREATOR = new ddyd();
    public final int a;
    public final Flag[] b;
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof Configuration) {
            ...
            if (this.a == configuration.a && ddzo.a(this.d, configuration.d) && Arrays.equals(this.c, configuration.c)) {
                return true;
            }
        }
        return false;
