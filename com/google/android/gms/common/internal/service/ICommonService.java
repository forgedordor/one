    ...
    public static abstract class Stub extends BaseStub implements ICommonService {
        ...
        public static class Proxy extends BaseProxy implements ICommonService {
            ...
            public void clearDefaultAccount(ICommonCallbacks iCommonCallbacks) {
                ...
                sgh.f(parcelObtainAndWriteInterfaceToken, iCommonCallbacks);
        ...
        protected boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            ICommonCallbacks iCommonCallbacksAsInterface = ICommonCallbacks.Stub.asInterface(parcel.readStrongBinder());
            enforceNoDataAvail(parcel);
            clearDefaultAccount(iCommonCallbacksAsInterface);
            return true;
        }
    }
