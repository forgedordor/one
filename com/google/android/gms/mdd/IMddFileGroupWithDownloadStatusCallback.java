...
public interface IMddFileGroupWithDownloadStatusCallback extends IInterface {
    ...
    public static abstract class Stub extends BaseStub implements IMddFileGroupWithDownloadStatusCallback {
        ...
        public static IMddFileGroupWithDownloadStatusCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.mdd.IMddFileGroupWithDownloadStatusCallback");
            return iInterfaceQueryLocalInterface instanceof IMddFileGroupWithDownloadStatusCallback ? (IMddFileGroupWithDownloadStatusCallback) iInterfaceQueryLocalInterface : new Proxy(iBinder);
        }
        ...
        protected boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            ArrayList arrayListCreateTypedArrayList = parcel.createTypedArrayList(FileGroupWithDownloadStatus.CREATOR);
            enforceNoDataAvail(parcel);
            onFileGroupListRetrieved(status, arrayListCreateTypedArrayList);
            return true;
        }
    }
