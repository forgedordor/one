...
public class Barcode implements Parcelable {
    ...
    public static final Parcelable.Creator<Barcode> CREATOR = new didw();
    ...
    public static class Address implements Parcelable {
        public static final Parcelable.Creator<Address> CREATOR = new didx();
    ...
    public static class BoardingPass implements Parcelable {
        public static final Parcelable.Creator<BoardingPass> CREATOR = new didy();
    ...
    public static class CalendarDateTime implements Parcelable {
        public static final Parcelable.Creator<CalendarDateTime> CREATOR = new didz();
        public int day;
        public int hours;
    ...
    public static class CalendarEvent implements Parcelable {
        public static final Parcelable.Creator<CalendarEvent> CREATOR = new diea();
    ...
    public static class ContactInfo implements Parcelable {
        public static final Parcelable.Creator<ContactInfo> CREATOR = new dieb();
    ...
    public static class DriverLicense implements Parcelable {
        public static final Parcelable.Creator<DriverLicense> CREATOR = new diec();
    ...
    public static class Email implements Parcelable {
        public static final Parcelable.Creator<Email> CREATOR = new died();
        public static final int HOME = 2;
        public static final int UNKNOWN = 0;
        public static final int WORK = 1;
    ...
    public static class FlightSegment implements Parcelable {
        public static final Parcelable.Creator<FlightSegment> CREATOR = new diee();
    ...
    public static class GeoPoint implements Parcelable {
        public static final Parcelable.Creator<GeoPoint> CREATOR = new dief();
        public double lat;
        public double lng;
    ...
    public static class PersonName implements Parcelable {
        public static final Parcelable.Creator<PersonName> CREATOR = new dieg();
        public String first;
    ...
    public static class Phone implements Parcelable {
        public static final Parcelable.Creator<Phone> CREATOR = new dieh();
    ...
    public static class Sms implements Parcelable {
        public static final Parcelable.Creator<Sms> CREATOR = new diei();
    ...
    public static class UrlBookmark implements Parcelable {
        public static final Parcelable.Creator<UrlBookmark> CREATOR = new diej();
        public String title;
        public String url;
    ...
    public static class WiFi implements Parcelable {
        public static final Parcelable.Creator<WiFi> CREATOR = new diek();
