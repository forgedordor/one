...
public class Barhopper {
    ...
    public static Barcode[] recognize(int i, int i2, int i3, byte[] bArr, RecognitionOptions recognitionOptions) {
        return recognizeStridedNative(i, i2, i3, bArr, recognitionOptions);
    }
