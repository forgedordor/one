...
public abstract class AddUserToGroupRequest implements Parcelable, efdi {
    public static final Parcelable.Creator<AddUserToGroupRequest> CREATOR = new efba();
    ...
    public final void writeToParcel(final Parcel parcel, int i) {
        ...
        d().ifPresent(new Consumer() { // from class: efaz
