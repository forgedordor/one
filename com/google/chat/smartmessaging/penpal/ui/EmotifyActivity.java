...
import defpackage.ejdq;
import defpackage.ejds;
import defpackage.ejdt;
import defpackage.ejfj;
import defpackage.ejfl;
...
public final class EmotifyActivity extends ejfl implements ehlg, ehld, ehnq {
    private ejdt o;
    private boolean q;
    private Context r;
    private lvn t;
        ...
        if (this.o == null) {
            ...
            try {
                ...
                try {
                    try {
                        Object objBb = bb();
                        this.o = new ejdt(((ahhk) objBb).cF, ((ahhk) objBb).cG, ((ahhk) objBb).N);
                        eieuVarK.close();
    ...
    @Override // defpackage.ejfl
    public final /* synthetic */ eyhb B() {
    ...
    @Override // defpackage.ejfl, defpackage.ecdl, defpackage.eg, defpackage.abi, defpackage.hl, android.app.Activity
    public final void onCreate(Bundle bundle) {
        ...
        try {
            ...
            objB.getClass();
            ejfj ejfjVar = (ejfj) new lxo((lxq) objB).a(ejfj.class);
            ejfjVar.k = ((EmotifyActivity) fcsuVar.b()).getIntent().getBooleanExtra("use_external_storage", false);
            ejfjVar.l = ((EmotifyActivity) fcsuVar.b()).getIntent().getFloatExtra("small_segment_ratio", 0.0f);
            fcsu fcsuVar2 = ejdtVar.b;
            Object objB2 = fcsuVar2.b();
            objB2.getClass();
            fdil.d((fdjx) objB2, null, null, new ejdq(ejdtVar, ejfjVar, null), 3);
            Object objB3 = fcsuVar2.b();
            objB3.getClass();
            fdil.d((fdjx) objB3, null, null, new ejds(ejfjVar, ejdtVar, null), 3);
            this.q = false;
            eibpVar.m();
            eifpVarT.close();
        } catch (Throwable th) {
    ...
    @Override // defpackage.ejfl, defpackage.ecdl, defpackage.iy, defpackage.eg, android.app.Activity
