...
public class VCardConstants {
    public static final int DEFAULT_APPEARANCE_ORDER = 0;
    ...
    public static final String PROPERTY_MAILER = "MAILER";
    ...
    public static final String PROPERTY_TZ = "TZ";
    ...
    /* compiled from: PG */
    public static final class ImportOnly {
