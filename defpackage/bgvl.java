...
public final class bgvl {
    ...
    static {
        ...
        ekgiVar.i("reports_concat_view._id_read_reports", 0);
        ekgiVar.i("reports_concat_view.message_id_read_reports", 0);
        ekgiVar.i("reports_concat_view.participant_id_read_reports", 0);
        ekgiVar.i("reports_concat_view.receive_time_read_reports", 0);
        ekgiVar.i("reports_concat_view.read_time_read_reports", 0);
        ekgiVar.i("reports_concat_view.ftd_time_read_reports", 0);
        ekgiVar.i("user_refs_concat_view.message_id_user_references", 0);
        ekgiVar.i("user_refs_concat_view.participant_id_user_references", 0);
        ekgiVar.i("user_refs_concat_view.user_ref_datetime_user_references", 0);
        ...
        ekgiVar.i("user_refs_concat_view.normalized_destination_participants", 0);
        ekgiVar.i("user_refs_concat_view.color_palette_index_participants", 0);
        ekgiVar.i("user_refs_concat_view.color_type_participants", 0);
        ekgiVar.i("user_refs_concat_view.extended_color_participants", 0);
        ...
        ekgiVar.i("message_replies_view.message_id_message_replies", 0);
        ekgiVar.i("message_replies_view._id_messages", 0);
        ekgiVar.i("message_replies_view.received_timestamp_messages", 0);
        ekgiVar.i("message_replies_view._id_participants", 0);
        ekgiVar.i("message_replies_view.sub_id_participants", 0);
        ekgiVar.i("message_replies_view.normalized_destination_participants", 0);
        ekgiVar.i("message_replies_view.display_destination_participants", 0);
        ekgiVar.i("message_replies_view.full_name_participants", 0);
        ekgiVar.i("message_replies_view.first_name_participants", 0);
        ekgiVar.i("message_replies_view._id_parts", 0);
        ekgiVar.i("message_replies_view.text_parts", 0);
        ekgiVar.i("message_replies_view.uri_parts", 0);
        ekgiVar.i("message_replies_view.content_type_parts", 0);
        ekgiVar.i("message_replies_view.file_name_parts", 0);
        ekgiVar.i("message_replies_view.duration_parts", 0);
        ekgiVar.i("message_replies_view.trigger_url_link_preview", 0);
        ekgiVar.i("message_replies_view.expiration_time_millis_link_preview", 0);
        ekgiVar.i("message_replies_view.link_title_link_preview", 0);
        ekgiVar.i("message_replies_view.link_image_url_link_preview", 0);
        ekgiVar.i("message_replies_view.link_preview_failed_link_preview", 0);
        b = ekgiVar.c();
    ...
    public static final bgvg a() {
        ...
        if (numC.intValue() == Integer.MAX_VALUE) {
            ...
            if (numC.intValue() >= 0) {
                ekfwVar.h("reports_concat_view._id_read_reports");
            }
            if (numC.intValue() >= 0) {
                ekfwVar.h("reports_concat_view.message_id_read_reports");
            }
            if (numC.intValue() >= 0) {
                ekfwVar.h("reports_concat_view.participant_id_read_reports");
            }
            if (numC.intValue() >= 0) {
                ekfwVar.h("reports_concat_view.receive_time_read_reports");
            }
            if (numC.intValue() >= 0) {
                ekfwVar.h("reports_concat_view.read_time_read_reports");
            }
            if (numC.intValue() >= 0) {
                ekfwVar.h("reports_concat_view.ftd_time_read_reports");
            }
            if (numC.intValue() >= 0) {
                ekfwVar.h("user_refs_concat_view.message_id_user_references");
            }
            if (numC.intValue() >= 0) {
                ekfwVar.h("user_refs_concat_view.participant_id_user_references");
            }
            if (numC.intValue() >= 0) {
                ekfwVar.h("user_refs_concat_view.user_ref_datetime_user_references");
            }
            if (numC.intValue() >= 0) {
                ekfwVar.h("user_refs_concat_view.user_ref_display_name");
            }
            if (numC.intValue() >= 0) {
                ekfwVar.h("user_refs_concat_view.user_ref_profile_photo_uri");
            }
            if (numC.intValue() >= 0) {
                ekfwVar.h("user_refs_concat_view.user_ref_full_name");
            }
            if (numC.intValue() >= 0) {
                ekfwVar.h("user_refs_concat_view.user_ref_lookup_key");
            }
            if (numC.intValue() >= 0) {
                ekfwVar.h("user_refs_concat_view.normalized_destination_participants");
            }
            if (numC.intValue() >= 0) {
                ekfwVar.h("user_refs_concat_view.color_palette_index_participants");
            }
            if (numC.intValue() >= 0) {
                ekfwVar.h("user_refs_concat_view.color_type_participants");
            }
            if (numC.intValue() >= 0) {
                ekfwVar.h("user_refs_concat_view.extended_color_participants");
            }
