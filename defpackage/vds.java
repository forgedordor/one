...
public final class vds extends vdx implements ehlg, eyhx, ehlc, ehnw, eifl {
    private vdu a;
    private boolean ag;
    private Context d;
    ...
    public final View M(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        try {
            ...
            View viewInflate = layoutInflater.inflate(R.layout.conversation2_root_fragment, viewGroup, false);
    ...
    @Override // defpackage.vdx, defpackage.ecdo, defpackage.ea
    ...
    @Override // defpackage.vdx, defpackage.ehnp, defpackage.ea
    public final void g(Context context) {
        ...
        try {
            ...
            if (this.a == null) {
                try {
                    eieu eieuVarG = eiiy.g("com/google/android/apps/messaging/conversation2/Conversation2MainActivityAdapterFragment", 88, vds.class, "CreateComponent");
                    try {
                        Object objBb = bb();
                        eieuVarG.close();
                        eieu eieuVarG2 = eiiy.g("com/google/android/apps/messaging/conversation2/Conversation2MainActivityAdapterFragment", 93, vds.class, "CreatePeer");
                        try {
                            ea eaVar = (ea) ((eyig) ((ahhw) objBb).e).a;
                            if (!(eaVar instanceof vds)) {
                                throw new IllegalStateException(a.M(eaVar, vdu.class));
                            }
                            vds vdsVar = (vds) eaVar;
                            efwo efwoVar = (efwo) ((ahhw) objBb).b.b.b();
                            ahng ahngVar = ((ahhw) objBb).a.b;
                            eygg eyggVarA = eyie.a(ahngVar.iF);
                            ahhe ahheVar = ((ahhw) objBb).d;
                            this.a = new vdu(vdsVar, efwoVar, eyggVarA, eyie.a(ahheVar.u), eyie.a(ahheVar.p), ahngVar.jo);
                            eieuVarG2.close();
    ...
    @Override // defpackage.vdx, defpackage.ea
