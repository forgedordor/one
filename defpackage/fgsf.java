...
final class fgsf {
    ...
    static final String[] g = {"base", "basefont", "bgsound", "command", "link", "meta", "noframes", "script", "style", "template", ConversationSuggestion.SUGGESTION_PROPERTY_CALENDAR_TITLE};
    static final String[] h = {"address", "article", "aside", "blockquote", "center", "details", "dir", "div", "dl", "fieldset", "figcaption", "figure", "footer", BusinessInfoDatabaseConstants.BusinessInfoPropertiesTableConstants.Columns.HEADER, "hgroup", "menu", "nav", "ol", "p", "section", "summary", "ul"};
    ...
    static final String[] n = {GroupManagementRequest.ACTION_TAG, "name", "prompt"};
    static final String[] o = {"caption", "col", "colgroup", "frame", "head", "tbody", "td", "tfoot", "th", "thead", "tr"};
    static final String[] p = {"address", "article", "aside", "blockquote", "button", "center", "details", "dir", "div", "dl", "fieldset", "figcaption", "figure", "footer", BusinessInfoDatabaseConstants.BusinessInfoPropertiesTableConstants.Columns.HEADER, "hgroup", "listing", "menu", "nav", "ol", "pre", "section", "summary", "ul"};
    ...
    static final String[] K = {"base", "basefont", "bgsound", "link", "meta", "noframes", "script", "style", "template", ConversationSuggestion.SUGGESTION_PROPERTY_CALENDAR_TITLE};
