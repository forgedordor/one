...
public final class atpu implements atsk {
    ...
    private static void b(String str, atrj atrjVar) {
        ...
        ((eksl) ekrwVarN.h("com/google/android/apps/messaging/shared/chatapi/groups/groupevent/GroupEventErrorStateConverter", "logExistingErrorState", 238, "GroupEventErrorStateConverter.java")).D("#%s existing error state %s", str, atrjVar.d().name());
    }
    ...
    */
    public final /* bridge */ /* synthetic */ defpackage.auey a(java.lang.Object r11, defpackage.atrj r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.atpu.a(java.lang.Object, atrj):auey");
    }
}
