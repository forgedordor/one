...
final class fbxe implements fcan {
    private final fbvx a;
    private final fbwn b;
    private InputStream c;
    private fbol d;

    public fbxe(fbvx fbvxVar, fbwn fbwnVar) {
        this.a = fbvxVar;
        this.b = fbwnVar;
    }
    ...
    public final void n(InputStream inputStream) {
        ...
        fbvx fbvxVar = this.a;
        synchronized (fbvxVar) {
            fbvxVar.h(Status.o.withDescription("too many messages"));
        }
    }
    ...
    public final String toString() {
        fbwn fbwnVar = this.b;
        return "SingleMessageClientStream[" + this.a.toString() + "/" + fbwnVar.toString() + "]";
    }
