...
public final class cuv extends cvk {
    private int h;
    ...
    private final void k(int i) {
        ...
        if (i3 == 0) {
            ...
            jArr2 = new long[i3];
            fcur.t(jArr2, 4611686018427387903L, jArr2.length);
        }
        this.c = jArr2;
    }
                ...
                if (this.h != 0 || ((this.a[i16 >> 3] >> ((i16 & 7) << 3)) & 255) == 254) {
                    ...
                    if (i17 <= 8 || Long.compare((this.g * 32) ^ Long.MIN_VALUE, (i17 * 25) ^ Long.MIN_VALUE) > 0) {
                        ...
                        if (jArr9 == null) {
                            ...
                            j2 = 255;
                            fcur.t(jArr11, 9223372034707292159L, i27);
                            int i28 = (i27 + 7) >> 3;
                            int i29 = 0;
                            while (i29 < i28) {
                                int i30 = i13;
                            ...
                            for (int i47 = i; i47 < length2; i47++) {
                                long j26 = jArr12[i47];
                                jArr12[i47] = (((j26 & (-4611686018427387904L)) | (((int) ((j26 >> 31) & 2147483647L)) == Integer.MAX_VALUE ? Integer.MAX_VALUE : (int) (jArr11[r6] & 4294967295L))) << 31) | (((int) (j26 & 2147483647L)) == Integer.MAX_VALUE ? Alert.DURATION_SHOW_INDEFINITELY : (int) (jArr11[r8] & 4294967295L));
                            }
                            int i48 = this.d;
    ...
    public final void b() {
        ...
        fcur.d(this.b, null, 0, this.f);
        long[] jArr3 = this.c;
        fcur.t(jArr3, 4611686018427387903L, jArr3.length);
    ...
    */
    public final boolean e(java.lang.Object r18) {
        ...
        L80:
            ...
            goto L19
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cuv.e(java.lang.Object):boolean");
    }
    ...
    public /* synthetic */ cuv(byte[] bArr) {
        this(6);
    }
}
