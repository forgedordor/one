...
public final class boip extends dqwl<boie, boip, boiq, bohm, boid> {
    public boip(dqwv dqwvVar) {
        super(dqwvVar);
    }
    ...
    public final /* synthetic */ dqqj a(dqsy dqsyVar, Cursor cursor, String[] strArr, dqxe[] dqxeVarArr, dqwj dqwjVar, dqtm dqtmVar) {
        return new boij(dqsyVar, cursor, strArr, dqxeVarArr, dqwjVar, dqtmVar, this);
    }
