...
class edsa extends eefb implements eyhy, eyhr {
    ...
    protected final void aW() {
        if (aY(X()) && !this.ag) {
            this.ag = true;
            edsi edsiVar = (edsi) this;
            ahib ahibVar = (ahib) bb();
            ahng ahngVar = ahibVar.a.b;
            edsiVar.ah = ahngVar.cm();
            ahhk ahhkVar = ahibVar.c;
            edsiVar.ai = (eduu) ahhkVar.cT.b();
            edsiVar.aj = (eddy) ahhkVar.bR.b();
            edsiVar.ak = (dswb) ahngVar.iZ.b();
            edsiVar.al = (dsvh) ahngVar.jc.b();
            edsiVar.am = ahhkVar.ae();
            edsiVar.an = (edmz) ahhkVar.cj.b();
            edsiVar.ao = (edgv) ahhkVar.bC.b();
            edsiVar.ap = (edgm) ahhkVar.cU.b();
            edsiVar.aq = (eduy) ahhkVar.cp.b();
        }
    }
