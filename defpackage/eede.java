...
public class eede<V extends View> extends eedh<V> {
    private Runnable a;
    OverScroller b;
    private boolean c;
    private int d;
    ...
    */
    public final boolean f(androidx.coordinatorlayout.widget.CoordinatorLayout r7, android.view.View r8, android.view.MotionEvent r9) {
        ...
        L90:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.eede.f(androidx.coordinatorlayout.widget.CoordinatorLayout, android.view.View, android.view.MotionEvent):boolean");
    }
    ...
    */
    public final boolean j(androidx.coordinatorlayout.widget.CoordinatorLayout r19, android.view.View r20, android.view.MotionEvent r21) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.eede.j(androidx.coordinatorlayout.widget.CoordinatorLayout, android.view.View, android.view.MotionEvent):boolean");
    }
    ...
    public eede(Context context, AttributeSet attributeSet) {
