...
final class evtk extends InputStream implements InputStreamRetargetInterface {
    private Iterator a;
    ...
    private final boolean b() {
        ...
        do {
            ...
            byteBuffer = (ByteBuffer) this.a.next();
            this.b = byteBuffer;
    ...
    public final int read() {
        ...
        int iA = evvz.a(this.e + this.i) & 255;
        a(1);
        return iA;
    }
