...
public final class bbdz implements alez {
    private final String a;
    private final amwf c;
    private final alfd b = alfd.a;
    private final elny d = elny.PHONE_SMART_REPLY;

    public bbdz(final SmartSuggestionItemSuggestionData smartSuggestionItemSuggestionData) {
        this.a = smartSuggestionItemSuggestionData.a;
        this.c = new amwf() { // from class: bbdy
