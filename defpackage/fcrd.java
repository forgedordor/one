...
public final class fcrd {
    ...
    */
    public static java.net.InetAddress b(java.lang.String r17, int r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.fcrd.b(java.lang.String, int):java.net.InetAddress");
    }

    final int a() {
        int i = this.c;
        return i != -1 ? i : fcre.b(this.a);
    }
