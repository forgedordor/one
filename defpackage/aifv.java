...
public final class aifv extends aifi implements ehlg, eyhx, ehlc, ehnw, eifl {
    private aifw ah;
    private Context ai;
    ...
    @Override // defpackage.aifi, defpackage.ecdn, defpackage.ea
    ...
    @Override // defpackage.aifi, defpackage.dn, defpackage.ea
    public final void g(Context context) {
        ...
        try {
            ...
            if (this.ah == null) {
                try {
                    eieu eieuVarG = eiiy.g("com/google/android/apps/messaging/scheduledsend/conversation/dialog/ScheduledMessageOverwriteDraftDialogFragment", 95, aifv.class, "CreateComponent");
                    try {
                        Object objBb = bb();
                        eieuVarG.close();
                        eieu eieuVarG2 = eiiy.g("com/google/android/apps/messaging/scheduledsend/conversation/dialog/ScheduledMessageOverwriteDraftDialogFragment", 100, aifv.class, "CreatePeer");
                        try {
                            this.ah = new aifw(((ahib) objBb).as, ((ahib) objBb).e(), ((ahib) objBb).a.b.nT);
                            eieuVarG2.close();
    ...
    public final Dialog gK(Bundle bundle) {
        super.gK(bundle);
        aifw aifwVarH = H();
        eeji eejiVar = new eeji(((aifv) aifwVarH.a.b()).z());
        eejiVar.k(R.string.scheduled_message_overwrite_draft_message);
        fcsu fcsuVar = aifwVarH.c;
        einm einmVar = (einm) fcsuVar.b();
        aifs aifsVar = aifwVarH.b;
        eejiVar.r(R.string.scheduled_message_dialog_continue, new einh(einmVar, new aifd(aifsVar)));
        eejiVar.m(R.string.scheduled_message_dialog_back, new einh((einm) fcsuVar.b(), new aier(aifsVar)));
    ...
    @Override // defpackage.aifi, defpackage.ea
