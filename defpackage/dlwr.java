...
public final class dlwr extends fcyz implements fdat {
    final /* synthetic */ dlwu a;
    final /* synthetic */ Uri b;
    final /* synthetic */ ebsu c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public dlwr(dlwu dlwuVar, Uri uri, ebsu ebsuVar, fcxy fcxyVar) {
        super(2, fcxyVar);
        this.a = dlwuVar;
        this.b = uri;
        this.c = ebsuVar;
    ...
    public final /* bridge */ /* synthetic */ Object a(Object obj, Object obj2) {
        return ((dlwr) c((fdjx) obj, (fcxy) obj2)).b(fctx.a);
    }
    ...
    public final Object b(Object obj) throws Throwable {
        ...
        AssetFileDescriptor assetFileDescriptorA = ebsv.a(dlwuVar.a, this.b, "r", this.c);
        try {
            dlwuVar.c = new MediaExtractor();
            MediaExtractor mediaExtractor = dlwuVar.c;
            ...
            dlwu dlwuVar2 = this.a;
            MediaExtractor mediaExtractor2 = dlwuVar2.c;
            ...
            for (int i = 0; i < trackCount; i++) {
                ...
                if (string != null && fdgn.t(string, "audio")) {
                    ...
                    MediaExtractor mediaExtractor3 = dlwuVar2.c;
                    ...
                    dlwuVar2.d = mediaCodecCreateByCodecName;
                    MediaCodec mediaCodec2 = dlwuVar2.d;
                    if (mediaCodec2 == null) {
                        fdbq.c("mediaCodec");
                        mediaCodec2 = null;
                    }
                    mediaCodec2.configure(mediaFormat, (Surface) null, (MediaCrypto) null, 0);
                    MediaCodec mediaCodec3 = dlwuVar2.d;
                    if (mediaCodec3 == null) {
                        fdbq.c("mediaCodec");
                        mediaCodec3 = null;
                    }
                    ...
                    MediaCodec mediaCodec4 = dlwuVar2.d;
                    if (mediaCodec4 == null) {
                        fdbq.c("mediaCodec");
                    } else {
                    ...
                    name.getClass();
                    return new dlww(integer, integer2, durationC, name);
                }
            }
    ...
    public final fcxy c(Object obj, fcxy fcxyVar) {
        return new dlwr(this.a, this.b, this.c, fcxyVar);
    }
}
