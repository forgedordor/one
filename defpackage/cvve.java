...
public final class cvve extends cvvv implements ehlg, eyhx, ehlc, ehnw, eifl {
    private cvvn a;
    private boolean ag;
    private Context d;
    ...
    public final View M(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        try {
            ...
            ComposeView composeView = new ComposeView(((cvve) cvvnVarH.b.b()).A(), null, 0, 6, null);
            composeView.a(new hxd(-930641910, true, new cvvh(cvvnVarH)));
            eidc.q();
            return composeView;
        } finally {
        }
    ...
    @Override // defpackage.cvvv, defpackage.ecdo, defpackage.ea
    ...
    @Override // defpackage.cvvv, defpackage.ehnp, defpackage.ea
    public final void g(Context context) {
        ...
        try {
            ...
            if (this.a == null) {
                try {
                    eieu eieuVarG = eiiy.g("com/google/android/apps/messaging/ui/conversation/details/ConversationDetailsFragment", 88, cvve.class, "CreateComponent");
                    try {
                        Object objBb = bb();
                        eieuVarG.close();
                        eieu eieuVarG2 = eiiy.g("com/google/android/apps/messaging/ui/conversation/details/ConversationDetailsFragment", 93, cvve.class, "CreatePeer");
                        try {
                            this.a = new cvvn(((ahhw) objBb).d.H, ((ahhw) objBb).dQ, ((ahhw) objBb).av, ((ahhw) objBb).by);
                            eieuVarG2.close();
    ...
    public final void h(Bundle bundle) {
        ...
        try {
            aX(bundle);
            cvvn cvvnVarH = H();
            afzd afzdVar = (afzd) cvvnVarH.a.b();
            afzdVar.a();
            afzdVar.b(agbf.a, true);
            fcsu fcsuVar = cvvnVarH.b;
            Intent intent = ((cvve) fcsuVar.b()).fg().getIntent();
            intent.getClass();
            ...
            Bundle bundle2 = ((cvve) fcsuVar.b()).m;
            if (bundle2 != null) {
    ...
    @Override // defpackage.cvvv, defpackage.ea
