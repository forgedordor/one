...
public final class cvdy extends cvdt implements ehlg, eyhx, ehlc, ehnw, eifl {
    private cvdz aj;
    private Context ak;
    ...
    @Override // defpackage.cvdt, defpackage.ecdm, defpackage.ea
    ...
    @Override // defpackage.cvdt, defpackage.ea
    public final void g(Context context) {
        ...
        try {
            ...
            if (this.aj == null) {
                try {
                    eieu eieuVarG = eiiy.g("com/google/android/apps/messaging/ui/appsettings/protectionandsafety/ProtectionSafetySettingsFragment", 94, cvdy.class, "CreateComponent");
                    try {
                        Object objBb = bb();
                        eieuVarG.close();
                        eieu eieuVarG2 = eiiy.g("com/google/android/apps/messaging/ui/appsettings/protectionandsafety/ProtectionSafetySettingsFragment", 99, cvdy.class, "CreatePeer");
                        try {
                            ea eaVar = (ea) ((eyig) ((ahib) objBb).d).a;
                            if (!(eaVar instanceof cvdy)) {
                                throw new IllegalStateException(a.M(eaVar, cvdz.class));
                            }
                            this.aj = new cvdz((cvdy) eaVar, ((ahib) objBb).aI, ((ahib) objBb).aJ, ((ahib) objBb).aK);
                            eieuVarG2.close();
    ...
    public final void gh(Bundle bundle, String str) {
        super.gh(bundle, str);
        cvdz cvdzVarH = H();
        cvdzVarH.a.f(R.xml.protection_safety_settings_preference_screen);
        Iterator it = cvdzVarH.b.iterator();
        while (it.hasNext()) {
            ((cvdx) it.next()).b();
        }
    }
