...
final class fcdx implements fbqx {
    @Override // defpackage.fbqx
    public final /* bridge */ /* synthetic */ Object a(String str) throws NumberFormatException {
        ejwl.b(str.length() > 0, "empty timeout");
        ejwl.b(str.length() <= 9, "bad timeout format");
