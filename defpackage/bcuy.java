...
public final class bcuy extends dqws {
    public bcuy(String[] strArr) {
    ...
    public final bcuw b() {
        l();
        return new bcuw(this.a.a());
    }

    public final void c(bcuv... bcuvVarArr) {
        D((String) DesugarArrays.stream(bcuvVarArr).map(new Function() { // from class: bcux
    ...
    public final void d(bcvd bcvdVar) {
        k(new bcuz(bcvdVar));
    }

    public final void e(Function function) {
        String[] strArr = bcve.a;
        k(new bcuz((bcvd) function.apply(new bcvd())));
    }
}
