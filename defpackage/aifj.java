...
public final class aifj extends aifg implements ehlg, eyhx, ehlc, ehnw, eifl {
    private aifk ah;
    private Context ai;
    ...
    @Override // defpackage.aifg, defpackage.ecdn, defpackage.ea
    ...
    @Override // defpackage.aifg, defpackage.dn, defpackage.ea
    public final void g(Context context) {
        ...
        try {
            ...
            if (this.ah == null) {
                try {
                    eieu eieuVarG = eiiy.g("com/google/android/apps/messaging/scheduledsend/conversation/dialog/ScheduledMessageConfirmDeleteDialogFragment", 95, aifj.class, "CreateComponent");
                    try {
                        Object objBb = bb();
                        eieuVarG.close();
                        eieu eieuVarG2 = eiiy.g("com/google/android/apps/messaging/scheduledsend/conversation/dialog/ScheduledMessageConfirmDeleteDialogFragment", 100, aifj.class, "CreatePeer");
                        try {
                            this.ah = new aifk(((ahib) objBb).aq, ((ahib) objBb).e(), ((ahib) objBb).a.b.nT);
                            eieuVarG2.close();
    ...
    public final Dialog gK(Bundle bundle) {
        super.gK(bundle);
        aifk aifkVarH = H();
        eeji eejiVar = new eeji(((aifj) aifkVarH.a.b()).z());
        eejiVar.k(R.string.scheduled_message_delete_confirmation);
        fcsu fcsuVar = aifkVarH.c;
        einm einmVar = (einm) fcsuVar.b();
        aifs aifsVar = aifkVarH.b;
        eejiVar.r(R.string.scheduled_message_dialog_continue, new einh(einmVar, new aifb(aifsVar.b)));
    ...
    @Override // defpackage.aifg, defpackage.ea
