...
public final class etcv {
    public static final etcs a;
    ...
    public static String f(Exception exc) {
        ...
        return "\nSee ".concat(etat.a((message == null || !message.contains("to module com.google.gson")) ? "reflection-inaccessible" : "reflection-inaccessible-to-module-gson"));
    }
    ...
    public static void g(AccessibleObject accessibleObject) throws SecurityException {
        try {
            ...
            throw new esyk("Failed making " + e(accessibleObject, false) + " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type." + f(e), e);
        }
    }
