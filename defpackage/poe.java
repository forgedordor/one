...
public final class poe extends pog implements Animatable {
    public final poc a;
    ...
    public static void a(Drawable drawable, pnz pnzVar) {
        if (drawable == null || pnzVar == null || !(drawable instanceof Animatable)) {
            return;
        }
        b((AnimatedVectorDrawable) drawable, pnzVar);
    }

    public static void b(AnimatedVectorDrawable animatedVectorDrawable, pnz pnzVar) {
        animatedVectorDrawable.registerAnimationCallback(pnzVar.a());
    }

    public static void c(AnimatedVectorDrawable animatedVectorDrawable, pnz pnzVar) {
        animatedVectorDrawable.unregisterAnimationCallback(pnzVar.a());
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        poc pocVar = this.a;
        pocVar.b.draw(canvas);
        if (pocVar.c.isStarted()) {
            invalidateSelf();
        }
    }
    ...
    public final Drawable.ConstantState getConstantState() {
        Drawable drawable = this.e;
        if (drawable != null) {
            return new pod(drawable.getConstantState());
        }
        return null;
    }
    ...
    public final void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, Resources.NotFoundException, IOException {
        ...
        while (eventType != 1 && (xmlPullParser.getDepth() >= depth || eventType != 3)) {
            if (eventType == 2) {
                ...
                if ("animated-vector".equals(name)) {
                    TypedArray typedArrayE = kyz.e(resources, theme, attributeSet, pnx.e);
                    int resourceId = typedArrayE.getResourceId(0, 0);
                    if (resourceId != 0) {
                        pop popVarB = pop.b(resources, resourceId, theme);
                        popVarB.c = false;
                        popVarB.setCallback(this.d);
                        poc pocVar = this.a;
                        pop popVar = pocVar.b;
                        if (popVar != null) {
                            popVar.setCallback(null);
                        }
                        pocVar.b = popVarB;
                    }
                    typedArrayE.recycle();
                } else if (GroupManagementRequest.TARGET_ATTRIBUTE.equals(name)) {
                    TypedArray typedArrayObtainAttributes = resources.obtainAttributes(attributeSet, pnx.f);
                    ...
                    if (resourceId2 != 0) {
                        ...
                        poc pocVar2 = this.a;
                        animatorLoadAnimator.setTarget(pocVar2.b.b.b.l.get(string));
                        if (pocVar2.d == null) {
                            pocVar2.d = new ArrayList();
                            pocVar2.e = new csq();
                        }
                        pocVar2.d.add(animatorLoadAnimator);
                        pocVar2.e.put(animatorLoadAnimator, string);
                    }
                    typedArrayObtainAttributes.recycle();
                } else {
                    continue;
        ...
        poc pocVar3 = this.a;
        if (pocVar3.c == null) {
            pocVar3.c = new AnimatorSet();
        }
        pocVar3.c.playTogether(pocVar3.d);
    }
}
