...
public final class dqkk extends eoqz implements AutoCloseable, eosd {
    public static final /* synthetic */ int b = 0;
    public final eosd a;
    private final eosc c;

    public dqkk(eosc eoscVar, eosd eosdVar) {
        this.c = eoscVar;
        this.a = eosdVar;
    }
    ...
    public final eosb schedule(Runnable runnable, long j, TimeUnit timeUnit) {
        ...
        return j <= 0 ? new dqkj(this.c.submit(runnable), System.nanoTime()) : new dqki(eosaVar, this.a.schedule(new Runnable() { // from class: dqkc
    ...
    public final eosb schedule(Callable callable, long j, TimeUnit timeUnit) {
        if (j <= 0) {
            return new dqkj(this.c.submit(callable), System.nanoTime());
        }
        final eosa eosaVar = new eosa(callable);
        return new dqki(eosaVar, this.a.schedule(new Runnable() { // from class: dqke
            @Override // java.lang.Runnable
            public final void run() {
                this.a.execute(eosaVar);
            }
    ...
    public final eosb scheduleAtFixedRate(final Runnable runnable, long j, long j2, TimeUnit timeUnit) {
        ...
        return new dqki(settableFutureCreate, this.a.scheduleAtFixedRate(new Runnable() { // from class: dqkd
            @Override // java.lang.Runnable
            public final void run() {
                int i = dqkk.b;
                final Runnable runnable2 = runnable;
                final SettableFuture settableFuture = settableFutureCreate;
                eossVar.execute(new Runnable() { // from class: dqkb
                    @Override // java.lang.Runnable
                    public final void run() {
                        int i2 = dqkk.b;
                        try {
    ...
    public final eosb scheduleWithFixedDelay(Runnable runnable, long j, long j2, TimeUnit timeUnit) {
        ...
        dqki dqkiVar = new dqki(settableFutureCreate, null);
        dqkiVar.a = this.a.schedule(new dqkg(this, runnable, settableFutureCreate, dqkiVar, j2, timeUnit), j, timeUnit);
        return dqkiVar;
    }
