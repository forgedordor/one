...
public final class ffve extends KeyFactorySpi implements ffks {
    ...
    public final PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        try {
            return new ffvc(PrivateKeyInfo.b(ASN1Primitive.v(((PKCS8EncodedKeySpec) keySpec).getEncoded())));
        } catch (Exception e) {
    ...
    public final PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        try {
            return new ffvd(SubjectPublicKeyInfo.b(((X509EncodedKeySpec) keySpec).getEncoded()));
        } catch (Exception e) {
            throw new InvalidKeySpecException(e.toString());
        }
    }
    ...
    public final KeySpec engineGetKeySpec(Key key, Class cls) throws InvalidKeySpecException {
        if (key instanceof ffvc) {
            if (PKCS8EncodedKeySpec.class.isAssignableFrom(cls)) {
                return new PKCS8EncodedKeySpec(key.getEncoded());
            }
        } else {
            if (!(key instanceof ffvd)) {
    ...
    public final Key engineTranslateKey(Key key) throws InvalidKeyException {
        if ((key instanceof ffvc) || (key instanceof ffvd)) {
            return key;
        }
