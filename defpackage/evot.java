...
public enum evot {
    ...
    REQUEST_AVIF("ra", 2),
    DUMMY_CACHE_KEY_MODIFIER("ckm", 2),
    GAIN_MAP("gm", 2),
    NO_GAIN_MAP("ngm", 2),
    EXPIRATION_TIME_IN_MINUTES("em", 4),
    FORCE_COOKIE_REDIRECT("cr", 2),
    STORYBOARD_LEVEL("sl", 4),
    STORYBOARD_MOSAIC("sb", 4),
    PREGEN_TIMESTAMPS("pt", 3),
    CLIENT_EXPERIMENT_LABEL("gce", 3),
    TONE_MAP("tm", 2),
    NO_TONE_MAP("ntm", 2);
