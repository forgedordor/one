...
public enum dtow {
    ...
    ANDROID_DOWNLOADER_CANCELED(EnergyProfile.EVCONNECTOR_TYPE_OTHER),
    ...
    ANDROID_DOWNLOADER2_ERROR(BasePaymentResult.ERROR_REQUEST_FAILED),
    GROUP_NOT_FOUND_ERROR(300),
    DOWNLOAD_MONITOR_NOT_PROVIDED_ERROR(301),
    INSECURE_URL_ERROR(302),
    LOW_DISK_ERROR(303),
    DUPLICATE_REQUEST_ERROR(331),
