...
final class kza {
    ...
    static {
        ...
        a = new kza(fC, (f24 + f24 + fArr8[1] + (f23 * 0.05f)) * f25, f25, f25, fArr6, f20, (float) Math.pow(f20, 0.25d), fSqrt + 1.48f);
    }

    private kza(float f, float f2, float f3, float f4, float[] fArr, float f5, float f6, float f7) {
        this.f = f;
        this.b = f2;
        this.c = f3;
        this.d = f4;
