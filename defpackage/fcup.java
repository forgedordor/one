...
final class fcup<T> implements Collection<T>, j$.util.Collection<T>, fdcn {
    private final Object[] a;
    private final boolean b;

    public fcup(Object[] objArr, boolean z) {
        this.a = objArr;
        this.b = z;
    }
    ...
    public final Object[] toArray() {
        ...
        if (z && fdbq.f(objArr.getClass(), Object[].class)) {
            return objArr;
        }
