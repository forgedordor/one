...
public final class eeps extends eeok {
    public final int o;
    public final int p;
    public boolean q;
    public int r;
    ...
    public eeps(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, R.attr.linearProgressIndicatorStyle, R.style.Widget_MaterialComponents_LinearProgressIndicator);
        TypedArray typedArrayA = eemh.a(context, attributeSet, eept.c, R.attr.linearProgressIndicatorStyle, R.style.Widget_MaterialComponents_LinearProgressIndicator, new int[0]);
