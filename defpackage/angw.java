...
public final class angw implements ajmf {
    private final MessageId a;
    private final ConversationId b;
    private final Instant c;

    public angw(MessageId messageId, ConversationId conversationId, Instant instant) {
        this.a = messageId;
    ...
    public final boolean equals(Object obj) {
        ...
        return fdbq.f(this.a, angwVar.a) && fdbq.f(this.b, angwVar.b) && fdbq.f(this.c, angwVar.c);
    }
