...
public final class agad implements agaj {
    public final int a;
    private final afzv b;
    private final String c = "DispatchedState";

    public agad(int i, afzv afzvVar) {
        this.a = i;
        this.b = afzvVar;
    }
    ...
    public final void d(afzu afzuVar) {
        afzuVar.getClass();
        if (!(afzuVar instanceof agaq) || ((agaq) afzuVar).a != this.a) {
    ...
    public final boolean equals(Object obj) {
        ...
        return this.a == agadVar.a && fdbq.f(this.b, agadVar.b);
    }
