...
public class lro extends InputStream implements DataInput, InputStreamRetargetInterface {
    ...
    public lro(InputStream inputStream) {
    ...
    public lro(InputStream inputStream, ByteOrder byteOrder) {
        DataInputStream dataInputStream = new DataInputStream(inputStream);
        this.a = dataInputStream;
        dataInputStream.mark(0);
        this.b = 0;
        this.c = byteOrder;
        this.d = inputStream instanceof lro ? ((lro) inputStream).d : -1;
    }
