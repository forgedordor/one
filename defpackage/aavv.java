...
public final class aavv extends aaxb implements ehlg, eyhx, ehlc, ehnw, eifl {
    private aavy ah;
    private Context ai;
    ...
    @Override // defpackage.aaxb, defpackage.ecdn, defpackage.ea
    ...
    @Override // defpackage.aaxb, defpackage.dn, defpackage.ea
    public final void g(Context context) {
        ...
        try {
            ...
            if (this.ah == null) {
                try {
                    eieu eieuVarG = eiiy.g("com/google/android/apps/messaging/datetimepicker/dialog/DateTimePickerDateDialogFragment", 95, aavv.class, "CreateComponent");
                    try {
                        Object objBb = bb();
                        eieuVarG.close();
                        eieu eieuVarG2 = eiiy.g("com/google/android/apps/messaging/datetimepicker/dialog/DateTimePickerDateDialogFragment", 100, aavv.class, "CreatePeer");
                        try {
                            ...
                            aawa aawaVar = (aawa) ProtoParsers.f(bundleA, "TIKTOK_FRAGMENT_ARGUMENT", aawa.a, evrrVar);
                            aawaVar.getClass();
                            ea eaVar = (ea) ((eyig) ((ahib) objBb).d).a;
                            if (!(eaVar instanceof aavv)) {
                                throw new IllegalStateException(a.M(eaVar, aavy.class));
                            }
                            this.ah = new aavy(aawaVar, (aavv) eaVar, ahknVar.cD);
                            eieuVarG2.close();
    ...
    public final Dialog gK(Bundle bundle) {
        super.gK(bundle);
        final aavy aavyVarH = H();
        ZonedDateTime zonedDateTimeAtZone = Instant.ofEpochMilli(aavyVarH.a.b).atZone(ZoneId.systemDefault());
        eg egVarG = aavyVarH.c.G();
        egVarG.getClass();
        DatePickerDialog.OnDateSetListener onDateSetListener = new DatePickerDialog.OnDateSetListener() { // from class: aavw
            ...
            public final void onDateSet(DatePicker datePicker, int i, int i2, int i3) {
                ...
                einf.f(new aaxk(ZonedDateTime.of(i, i2 + 1, i3, 0, 0, 0, 0, ZoneId.systemDefault())), aavyVarH.d);
            }
        };
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(egVarG, onDateSetListener, year, monthValue - 1, zonedDateTimeAtZone.getDayOfMonth());
        Context context = aavyVarH.b;
        datePickerDialog.setButton(-1, context.getString(R.string.datetime_picker_next_button), datePickerDialog);
        datePickerDialog.setButton(-2, context.getString(R.string.datetime_picker_back_button), new DialogInterface.OnClickListener() { // from class: aavx
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                einf.f(new aaxh(), aavyVarH.d);
            }
        });
        datePickerDialog.getDatePicker().setMinDate(((cogw) aavyVarH.e.b()).f().toEpochMilli());
    ...
    @Override // defpackage.aaxb, defpackage.ea
