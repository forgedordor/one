...
public final class qst {
    public static final qst a = new qst("COMPOSITION");
    public qsu b;
    private final List c;

    private qst(qst qstVar) {
        this.c = new ArrayList(qstVar.c);
        this.b = qstVar.b;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        qst qstVar = (qst) obj;
        if (!this.c.equals(qstVar.c)) {
            return false;
        }
        qsu qsuVar = this.b;
        return qsuVar != null ? qsuVar.equals(qstVar.b) : qstVar.b == null;
    }
    ...
    public final int hashCode() {
        ...
        qsu qsuVar = this.b;
        return iHashCode + (qsuVar != null ? qsuVar.hashCode() : 0);
    }
    ...
    public final String toString() {
        ...
        sb.append(",resolved=");
        sb.append(qsuVar != null);
        sb.append("}");
        return sb.toString();
    }

    public qst(String... strArr) {
