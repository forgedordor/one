...
class re {
    ...
    public re(ProgressBar progressBar) {
        this.c = progressBar;
    }

    /* JADX WARN: Multi-variable type inference failed */
    final Drawable a(Drawable drawable, boolean z) {
        if (drawable instanceof kzu) {
            kzu kzuVar = (kzu) drawable;
            Drawable drawableA = kzuVar.a();
            if (drawableA != null) {
                a(drawableA, z);
                kzuVar.b();
                return drawable;
    ...
    public void b(AttributeSet attributeSet, int i) {
        ...
        yx yxVarL = yx.l(progressBar.getContext(), attributeSet, b, i, 0);
        ...
        Drawable drawableI2 = yxVarL.i(1);
        if (drawableI2 != null) {
            progressBar.setProgressDrawable(a(drawableI2, false));
        }
        yxVarL.o();
    }
}
