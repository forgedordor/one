...
public final class bbtc extends dqwl<bbtb, bbtc, bbtd, ConversationIdsQuery.BindData, bbta> {
    public bbtc(dqwv dqwvVar) {
        super(dqwvVar);
    }
    ...
    public final /* synthetic */ dqqj a(dqsy dqsyVar, Cursor cursor, String[] strArr, dqxe[] dqxeVarArr, dqwj dqwjVar, dqtm dqtmVar) {
        return new bbtb(dqsyVar, cursor, strArr, dqxeVarArr, dqwjVar, dqtmVar, this);
    }

    @Override // defpackage.dqwl
    protected final Map b() {
        String[] strArr = ConversationIdsQuery.a;
        return new HashMap();
    }
