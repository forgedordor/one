...
public class lcl {
    ...
    public void c(View view, lhg lhgVar) {
        this.b.onInitializeAccessibilityNodeInfo(view, lhgVar.a);
    }
    ...
    public boolean i(View view, int i, Bundle bundle) {
        ...
        while (true) {
            ...
            lhd lhdVar = (lhd) listQ.get(i2);
            if (lhdVar.a() != i) {
                i2++;
            } else if (lhdVar.r != null) {
                Class cls = lhdVar.q;
                if (cls != null) {
                    try {
                    } catch (Exception e) {
                ...
                zPerformAccessibilityAction = lhdVar.r.a(view);
            }
        }
    ...
    public lcl(View.AccessibilityDelegate accessibilityDelegate) {
