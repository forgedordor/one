...
public final class eedj {
    ...
    public static void a(View view, float f) throws Resources.NotFoundException {
        ...
        long j = integer;
        stateListAnimator.addState(new int[]{R.attr.state_enabled, com.google.android.apps.messaging.R.attr.state_liftable, -2130970588}, ObjectAnimator.ofFloat(view, "elevation", 0.0f).setDuration(j));
