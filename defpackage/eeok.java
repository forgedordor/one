...
public class eeok {
    ...
    protected eeok(Context context, AttributeSet attributeSet, int i, int i2) throws Resources.NotFoundException {
        this.e = new int[0];
        int dimensionPixelSize = context.getResources().getDimensionPixelSize(R.dimen.mtrl_progress_track_thickness);
        TypedArray typedArrayA = eemh.a(context, attributeSet, eept.a, i, i2, new int[0]);
        int iA = eepy.a(context, typedArrayA, 10, dimensionPixelSize);
        this.a = iA;
        TypedValue typedValuePeekValue = typedArrayA.peekValue(9);
        if (typedValuePeekValue != null) {
            if (typedValuePeekValue.type == 5) {
                this.b = Math.min(TypedValue.complexToDimensionPixelSize(typedValuePeekValue.data, typedArrayA.getResources().getDisplayMetrics()), iA / 2);
                this.d = false;
        ...
        if (!typedArrayA.hasValue(3)) {
            this.e = new int[]{eehg.c(context, R.attr.colorPrimary, -1)};
        ...
        if (typedArrayA.hasValue(8)) {
            ...
            this.f = eehg.a(this.f, (int) (f * 255.0f));
        }
        typedArrayA.recycle();
    }
