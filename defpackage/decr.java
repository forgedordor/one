...
public final class decr implements Parcelable.Creator {
    ...
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < iH) {
            ...
            if (iD == 1) {
                ...
                arrayListZ = dclv.z(parcel, i, Annotation.CREATOR);
            } else if (iD != 3) {
                dclv.C(parcel, i);
            } else {
        ...
        dclv.B(parcel, iH);
        return new AnnotateCall$Response(status, arrayListZ, bundleK);
    }
