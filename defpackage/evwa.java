...
final class evwa {
    public static void a(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws evtj {
    ...
    */
    public static void c(byte r2, byte r3, byte r4, char[] r5, int r6) throws defpackage.evtj {
        /*
            boolean r0 = i(r3)
            if (r0 != 0) goto L30
            r0 = -96
        ...
        L30:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.evwa.c(byte, byte, byte, char[], int):void");
    }

    public static void d(byte b, byte b2, char[] cArr, int i) throws evtj {
        if (b < -62 || i(b2)) {
            throw new evtj("Protocol message had invalid UTF-8.");
        }
