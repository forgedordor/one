...
public final class jzd {
    ...
    public jzd(CharSequence charSequence, TextPaint textPaint, int i) {
        this.a = charSequence;
        this.b = textPaint;
        this.d = i;
    }
    ...
    private final CharSequence d() {
        ...
        if (charSequence == null) {
            ...
            if (charSequence instanceof Spanned) {
                ...
                if (jzf.a(spanned, CharacterStyle.class) && (characterStyleArr = (CharacterStyle[]) spanned.getSpans(0, charSequence.length(), CharacterStyle.class)) != null && characterStyleArr.length != 0) {
                    Iterator itA = fdbd.a(characterStyleArr);
    ...
    */
    public final float b() {
        ...
        L37:
            ...
            java.lang.Class<kab> r4 = defpackage.kab.class
            boolean r4 = defpackage.jzf.a(r2, r4)
            if (r4 != 0) goto L55
            java.lang.Class<kaa> r4 = defpackage.kaa.class
            boolean r2 = defpackage.jzf.a(r2, r4)
            if (r2 != 0) goto L55
        L4d:
        ...
        L58:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.jzd.b():float");
    }
    ...
    public final BoringLayout.Metrics c() {
        if (!this.g) {
            ...
            TextDirectionHeuristic textDirectionHeuristicB = jzl.b(i);
