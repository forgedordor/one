...
public final class ldj {
    ...
    public final boolean d(float f, float f2, boolean z) {
        ...
        return lfk.e(viewParent, this.d, f, f2, z);
    }
    ...
    public final boolean e(float f, float f2) {
        ...
        return lfk.f(viewParent, this.d, f, f2);
    }
    ...
    public final boolean g(int i, int i2, int[] iArr, int[] iArr2, int i3) {
        ...
        iArr3[1] = 0;
        View view = this.d;
        lfk.a(viewParentN, view, i4, i2, iArr3, i3);
        if (iArr2 != null) {
    ...
    public final boolean i(int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        ...
        View view = this.d;
        lfk.b(viewParentN, view, i6, i7, i8, i4, i5, iArr3);
        if (iArr4 != null) {
    ...
    public final boolean m(int i, int i2) {
        ...
        for (ViewParent parent = view.getParent(); parent != null; parent = parent.getParent()) {
            if (lfk.g(parent, view2, view, i, i2)) {
                o(i2, parent);
                lfk.c(parent, view2, view, i, i2);
                return true;
            }
