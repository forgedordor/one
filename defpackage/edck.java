...
class edck extends ea implements eyhy, eyhr {
    ...
    protected final void b() {
        if (p(X()) && !this.at) {
            this.at = true;
            edcj edcjVar = (edcj) this;
            ahib ahibVar = (ahib) bb();
            ahhk ahhkVar = ahibVar.c;
            edcjVar.a = (lxo) ahhkVar.ci.b();
            edcjVar.b = (eduu) ahhkVar.cT.b();
            ahng ahngVar = ahibVar.a.b;
            edcjVar.d = ahngVar.nO;
            edcjVar.e = (edgv) ahhkVar.bC.b();
            edcjVar.ag = (edgp) ahhkVar.co.b();
            edcjVar.ah = (dswb) ahngVar.iZ.b();
            edcjVar.ai = (dsvx) ahngVar.ja.b();
            edcjVar.aj = (dsvh) ahngVar.jc.b();
        }
    }
