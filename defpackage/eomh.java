...
public final class eomh {
    private static final ejvf a = new ejuv('.');
    private static final ejvf b = new ejuv(':');

    static {
    }

    public static InetAddress a(String str) {
        eomg eomgVar = new eomg();
        byte[] bArrE = e(str, eomgVar);
        if (bArrE != null) {
            return d(bArrE, eomgVar.a);
        }
    ...
    private static InetAddress d(byte[] bArr, String str) throws SocketException, UnknownHostException {
        try {
            ...
            ejwl.b(byAddress instanceof Inet6Address, "Unexpected state, scope should only appear for ipv6");
            ...
            try {
                ...
                throw new IllegalArgumentException(a.v(str, "No such interface: "), e);
            }
    ...
    */
    private static byte[] e(java.lang.String r13, defpackage.eomg r14) {
        /*
            Method dump skipped, instructions count: 353
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.eomh.e(java.lang.String, eomg):byte[]");
    }
