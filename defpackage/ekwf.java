...
public enum ekwf {
    ...
    static {
        ...
        for (ekwf ekwfVar : values()) {
            if (map.put(Character.valueOf(ekwfVar.G), ekwfVar) != null) {
                throw new IllegalStateException("duplicate format character: ".concat(String.valueOf(String.valueOf(ekwfVar))));
            }
        }
