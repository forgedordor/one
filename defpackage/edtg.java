...
class edtg extends ea implements eyhy, eyhr {
    ...
    protected final void b() {
        if (p(X()) && !this.a) {
            this.a = true;
            edtj edtjVar = (edtj) this;
            ahib ahibVar = (ahib) bb();
            ahhk ahhkVar = ahibVar.c;
            edtjVar.b = new edtl(ahhkVar.am());
            edtjVar.c = ahibVar.D();
            edtjVar.d = (dswb) ahibVar.a.b.iZ.b();
            edtjVar.e = (eduu) ahhkVar.cT.b();
        }
    }
