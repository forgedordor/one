...
final class evwe {
    ...
    static String f(ByteBuffer byteBuffer, int i, int i2) {
        ...
        if (byteBuffer.hasArray()) {
            return evwbVar.b(byteBuffer.array(), byteBuffer.arrayOffset() + i, i2);
        }
        return byteBuffer.isDirect() ? evwc.c(byteBuffer, i, i2) : evwb.c(byteBuffer, i, i2);
    }
