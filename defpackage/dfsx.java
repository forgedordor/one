...
public final class dfsx extends eyix {
    private final eyir b;
    private final eyir c;

    public dfsx(eyik eyikVar, eyik eyikVar2, eyir eyirVar, eyir eyirVar2) {
        super(eyikVar2, new eyji(dfsx.class), eyikVar);
    ...
    public final /* bridge */ /* synthetic */ ListenableFuture b(Object obj) {
        ...
        if (dftbVar.a().isPresent()) {
            ...
            optionalOfNullable = Optional.ofNullable(strK);
        } else {
            if (!dftbVar.b().isPresent()) {
                throw new IllegalArgumentException("Request doesn't not contain message or session!");
            }
            optionalOfNullable = Optional.ofNullable(((dgwe) dftbVar.b().get()).o);
        }
        return eork.i(optionalOfNullable);
    }
