...
public final class eruq implements eqrz {
    private final eqyd a;
    private final byte[] b;

    public eruq(byte[] bArr, byte[] bArr2) {
        this.a = new eqyd(bArr);
        this.b = bArr2;
    }
    ...
    private final byte[] c(byte[] bArr) throws GeneralSecurityException {
        ...
        return this.a.c(ByteBuffer.wrap(bArr, 12, length - 12), Arrays.copyOf(bArr, 12), null);
    }
