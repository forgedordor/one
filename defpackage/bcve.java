...
public final class bcve {
    ...
    public static final bcuu a(Cursor cursor) {
        if (!(cursor instanceof dqqf)) {
            return new bcuu(null, cursor, cursor.getColumnNames(), null, new dqwj() { // from class: bbtj
        ...
        dqqf dqqfVar = (dqqf) cursor;
        return new bcuu(dqqfVar.c, dqqfVar, dqqfVar.f, dqqfVar.g, new dqwj() { // from class: bbti
            @Override // defpackage.ejvr
            public final Object apply(Object obj) {
                String str = (String) obj;
                String[] strArr = bcve.a;
