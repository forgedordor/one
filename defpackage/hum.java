...
public final class hum implements RandomAccess {
    public Object[] a;
    public int b = 0;
    private List c;

    public hum(Object[] objArr) {
        this.a = objArr;
    }
    ...
    public final boolean l(Object obj) {
        int i = this.b - 1;
        if (i >= 0) {
            for (int i2 = 0; !fdbq.f(this.a[i2], obj); i2++) {
                if (i2 != i) {
                }
            }
            return true;
    ...
    public final void o(int i, hum humVar) {
        int i2 = humVar.b;
        if (i2 == 0) {
            return;
        }
        ...
        System.arraycopy(humVar.a, 0, objArr, i, i2);
        this.b += i2;
    }
