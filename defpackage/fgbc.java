...
final class fgbc extends ExperimentalBidirectionalStream {
    private final BidirectionalStream a;
    private final fgbj b;
    private final String c;
    private final Collection d;

    public fgbc(BidirectionalStream bidirectionalStream, fgbj fgbjVar, String str, Collection collection) {
    ...
    final void a(int i, fgbw fgbwVar, CronetException cronetException) {
        fgbn.a(this.b, this.c, this.d, null, i, fgbwVar, cronetException);
    }
