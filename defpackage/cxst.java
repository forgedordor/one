...
public class cxst extends ea implements eyhy {
    ...
    protected final void f() {
        ...
        eyik eyikVar = ahknVar.aN;
        ahnh ahnhVar = ahknVar.a;
        debugGServiceKeysFragment.ah = new cxaw(eyikVar, ahnhVar.oN);
        debugGServiceKeysFragment.ai = ahibVar.l;
        debugGServiceKeysFragment.ak = ahnhVar.oN;
        debugGServiceKeysFragment.al = ahknVar.y;
    }
