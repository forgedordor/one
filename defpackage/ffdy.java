...
public final class ffdy extends ffea {
    private final ffec a;

    public ffdy(ffec ffecVar) {
        this.a = ffecVar;
    }

    private static final boolean b(X509Certificate x509Certificate, X509Certificate x509Certificate2) {
        if (!fdbq.f(x509Certificate.getIssuerDN(), x509Certificate2.getSubjectDN())) {
            return false;
        }
        try {
    ...
    public final List a(List list, String str) throws SSLPeerUnverifiedException {
        ...
        for (int i = 0; i < 9; i++) {
            ...
            if (arrayList.size() > 1 || !fdbq.f(x509Certificate, x509CertificateA)) {
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof ffdy) && fdbq.f(((ffdy) obj).a, this.a);
    }
