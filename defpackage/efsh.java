...
public enum efsh {
    ...
    CONFIG_FOOTER_BUTTON_FONT_WEIGHT("setup_compat_footer_button_font_weight", 1),
    ...
    CONFIG_HEADER_FONT_WEIGHT("setup_design_header_font_weight", 1),
    CONFIG_HEADER_FONT_VARIATION_SETTINGS("setup_design_header_font_variation_settings", 5),
    ...
    CONFIG_ILLUSTRATION_MAX_WIDTH("setup_design_illustration_max_width", 6),
    CONFIG_ILLUSTRATION_MAX_HEIGHT("setup_design_illustration_max_height", 6),
    ...
    CONFIG_DESCRIPTION_FONT_WEIGHT("setup_design_description_font_weight", 1),
    ...
    CONFIG_ITEMS_TITLE_FONT_VARIATION_SETTINGS("setup_design_items_title_font_variation_settings", 5),
    CONFIG_ITEMS_PADDING_TOP("setup_design_items_padding_top", 6),
    CONFIG_ITEMS_PADDING_BOTTOM("setup_design_items_padding_bottom", 6),
    CONFIG_ITEMS_GROUP_CORNER_RADIUS("setup_design_items_group_corner_radius", 6),
    ...
    CONFIG_TWO_PANE_ADAPT_WINDOW_WIDTH("setup_compat_two_pane_adapt_window_width", 1);

    public final String bA;
    public final int bB;

    efsh(String str, int i) {
        this.bA = str;
        this.bB = i;
    }
}
