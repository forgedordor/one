...
public final class acnt extends actc implements ehlg, eyhx, ehlc, ehnw, eifl {
    private acnu a;
    private boolean ag;
    private Context d;
    ...
    public final View M(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        try {
            ...
            View viewInflate = layoutInflater.inflate(R.layout.conversation_list_root_fragment, viewGroup, false);
    ...
    @Override // defpackage.actc, defpackage.ecdo, defpackage.ea
    ...
    @Override // defpackage.actc, defpackage.ehnp, defpackage.ea
    public final void g(Context context) {
        ...
        try {
            ...
            if (this.a == null) {
                try {
                    eieu eieuVarG = eiiy.g("com/google/android/apps/messaging/home/AccountConversationListRootFragment", 88, acnt.class, "CreateComponent");
                    try {
                        Object objBb = bb();
                        eieuVarG.close();
                        eieu eieuVarG2 = eiiy.g("com/google/android/apps/messaging/home/AccountConversationListRootFragment", 93, acnt.class, "CreatePeer");
                        try {
                            ea eaVar = (ea) ((eyig) ((ahhw) objBb).e).a;
                            if (!(eaVar instanceof acnt)) {
                                throw new IllegalStateException(a.M(eaVar, acnu.class));
                            }
                            this.a = new acnu((acnt) eaVar, ((ahhw) objBb).b.b);
                            eieuVarG2.close();
    ...
    @Override // defpackage.actc, defpackage.ea
