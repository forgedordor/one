...
public final class hlh {
    ...
    static {
        float[][] fArr = hlg.a;
        float[] fArr2 = hlg.c;
        double d = hlg.d(50.0d) * 63.66197723675813d;
        float[][] fArr3 = hlg.a;
        float f = fArr2[0];
        float[] fArr4 = fArr3[0];
        float f2 = fArr4[0] * f;
        ...
        float fD = ((float) hlg.d(50.0d)) / fArr2[1];
        double d3 = fD;
        ...
        a = new hlh(fD, (f24 + f24 + fArr9[1] + (f23 * 0.05f)) * f25, f25, f25, fArr7, f20, (float) Math.pow(f20, 0.25d), fSqrt + 1.48f);
    }

    public hlh(float f, float f2, float f3, float f4, float[] fArr, float f5, float f6, float f7) {
        this.b = f;
        this.c = f2;
        this.d = f3;
        this.e = f4;
