...
final class phg extends phi {
    ...
    public phg(pjo pjoVar, String str) {
        super(pjoVar, str);
        this.a = new int[0];
        this.b = new long[0];
        this.c = new double[0];
    ...
    private final void p() {
        if (this.i == null) {
            this.i = this.f.a(new phf(this));
        }
    }

    private static final void q(Cursor cursor, int i) {
        if (i < 0 || i >= cursor.getColumnCount()) {
            pjk.b(25, "column index out of range");
            throw new fcta();
        }
    }
    ...
    @Override // defpackage.pjl, java.lang.AutoCloseable
