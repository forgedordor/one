...
public final class rpg extends FilterInputStream implements InputStreamRetargetInterface {
    ...
    public rpg(InputStream inputStream, rig rigVar) {
        super(inputStream);
        this.d = -1;
        this.f = rigVar;
        this.a = (byte[]) rigVar.a(65536, byte[].class);
    }
    ...
    */
    private final int c(java.io.InputStream r6, byte[] r7) throws java.io.IOException {
        ...
        L5f:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.rpg.c(java.io.InputStream, byte[]):int");
    }
    ...
    public final synchronized void reset() {
        ...
        int i = this.d;
        if (i == -1) {
            throw new rpf("Mark has been invalidated, pos: " + this.e + " markLimit: " + this.c);
        }
        this.e = i;
    }
    ...
    */
    public final synchronized int read(byte[] r6, int r7, int r8) {
        ...
        L84:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.rpg.read(byte[], int, int):int");
    }
}
