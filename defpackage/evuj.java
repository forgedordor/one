...
final class evuj {
    ...
    static void a(StringBuilder sb, int i, String str, Object obj) {
        ...
        if (obj instanceof String) {
            sb.append(": \"");
            sb.append(evvn.a(evqs.A((String) obj)));
            sb.append('\"');
            return;
        }
        if (obj instanceof evqs) {
            sb.append(": \"");
            sb.append(evvn.a((evqs) obj));
            sb.append('\"');
            return;
        }
    ...
    */
    public static void b(defpackage.evuh r18, java.lang.StringBuilder r19, int r20) {
        /*
            Method dump skipped, instructions count: 614
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.evuj.b(evuh, java.lang.StringBuilder, int):void");
    }
