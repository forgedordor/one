...
public final class cwut implements ixm {
    final /* synthetic */ hox a;
    final /* synthetic */ kpv b;
    final /* synthetic */ kpo c;
    final /* synthetic */ hox d;

    public cwut(hox hoxVar, kpv kpvVar, kpo kpoVar, hox hoxVar2) {
        this.a = hoxVar;
        this.b = kpvVar;
        this.c = kpoVar;
        this.d = hoxVar2;
    ...
    public final ixn e(ixp ixpVar, List list, long j) throws Throwable {
        ...
        this.d.a();
        return ixpVar.ej(kjg.b(jD), kjg.a(jD), fcvp.a, new cwus(kpvVar, list, linkedHashMap));
    }
}
