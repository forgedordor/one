...
public final class deuo {
    ...
    private static deuo c;
    private final Context d;

    public deuo(Context context) {
        this.d = context.getApplicationContext();
    }

    public static deuo a(Context context) {
        dclh.m(context);
        synchronized (deuo.class) {
            if (c == null) {
                c = new deuo(context);
            }
        }
    ...
    public final boolean b() {
        ...
        boolean zC;
        try {
            packageInfoB = dcnv.b(this.d).b("com.google.android.wearable.app.cn", 64);
        } catch (PackageManager.NameNotFoundException unused) {
            packageInfoB = null;
        }
        if (packageInfoB != null) {
            if (dceq.e(this.d)) {
                zC = c(packageInfoB, true);
            } else {
                boolean zC2 = c(packageInfoB, false);
                if (zC2 || !c(packageInfoB, true)) {
                    zC = zC2;
                } else {
