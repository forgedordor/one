...
public final class cynn extends cyqk implements ehlg, eyhx, ehlc, ehnw, eifl {
    private cyno a;
    private boolean ag;
    private Context d;
    ...
    @Override // defpackage.cyqk, defpackage.ecdo, defpackage.ea
    ...
    @Override // defpackage.cyqk, defpackage.ehnp, defpackage.ea
    public final void g(Context context) {
        ...
        try {
            ...
            if (this.a == null) {
                try {
                    eieu eieuVarG = eiiy.g("com/google/android/apps/messaging/ui/ditto/AccountDittoWelcomeFragment", 88, cynn.class, "CreateComponent");
                    try {
                        Object objBb = bb();
                        eieuVarG.close();
                        eieu eieuVarG2 = eiiy.g("com/google/android/apps/messaging/ui/ditto/AccountDittoWelcomeFragment", 93, cynn.class, "CreatePeer");
                        try {
                            ahjr ahjrVar = ((ahhw) objBb).b;
                            efwo efwoVar = (efwo) ahjrVar.b.b();
                            eyik eyikVar = ((ahhw) objBb).dR;
                            ahkn ahknVar = ((ahhw) objBb).a;
                            ahnh ahnhVar = ahknVar.a;
                            this.a = new cyno(efwoVar, eyikVar, ahnhVar.ws, ahknVar.hu, ((ahhw) objBb).cx, ahjrVar.cd, ((ahhw) objBb).dS, ((ahhw) objBb).n, ((ahhw) objBb).g, ahnhVar.wc, ahnhVar.rK, ahnhVar.pQ, ahnhVar.xk, ahknVar.dj, ((ahhw) objBb).dT, ((ahhw) objBb).cl, ahnhVar.rJ);
                            eieuVarG2.close();
    ...
    @Override // defpackage.cyqk, defpackage.ea
