...
public final class etaa {
    ...
    public static Class a(Type type) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            eszw.a(rawType instanceof Class);
    ...
    public static Type c(Type type) {
        if (type instanceof Class) {
            ...
            return cls.isArray() ? new eszx(c(cls.getComponentType())) : cls;
        }
        if (type instanceof ParameterizedType) {
            ParameterizedType parameterizedType = (ParameterizedType) type;
            return new eszy(parameterizedType.getOwnerType(), (Class) parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
        }
        if (type instanceof GenericArrayType) {
            return new eszx(((GenericArrayType) type).getGenericComponentType());
        }
        if (!(type instanceof WildcardType)) {
            return type;
        }
        WildcardType wildcardType = (WildcardType) type;
        return new eszz(wildcardType.getUpperBounds(), wildcardType.getLowerBounds());
    }
    ...
    public static Type d(Type type, Class cls, Class cls2) {
        ...
        eszw.a(cls2.isAssignableFrom(cls));
    ...
    /* JADX WARN: Removed duplicated region for block: B:91:0x0144 A[EDGE_INSN: B:91:0x0144->B:83:0x0144 BREAK  A[LOOP:0: B:3:0x0002->B:94:?], SYNTHETIC] */
    ...
    /* JADX WARN: Type inference failed for: r12v10, types: [eszx] */
    ...
    /* JADX WARN: Type inference failed for: r12v3, types: [eszz] */
    /* JADX WARN: Type inference failed for: r12v4, types: [eszz] */
    /* JADX WARN: Type inference failed for: r12v5, types: [java.lang.reflect.ParameterizedType] */
    /* JADX WARN: Type inference failed for: r12v6, types: [eszy] */
    /* JADX WARN: Type inference failed for: r12v7, types: [java.lang.reflect.GenericArrayType] */
    /* JADX WARN: Type inference failed for: r12v8, types: [eszx] */
    ...
    */
    private static java.lang.reflect.Type j(java.lang.reflect.Type r10, java.lang.Class r11, java.lang.reflect.Type r12, java.util.Map r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.etaa.j(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.Map):java.lang.reflect.Type");
    }
}
