...
public final class ufh extends ufm implements ehlg, eyhx, ehlc, ehnw, eifl {
    private ufk ah;
    private Context ai;
    ...
    @Override // defpackage.ufm, defpackage.ecdn, defpackage.ea
    ...
    @Override // defpackage.ufm, defpackage.dn, defpackage.ea
    public final void g(Context context) {
        ...
        try {
            ...
            if (this.ah == null) {
                try {
                    eieu eieuVarG = eiiy.g("com/google/android/apps/messaging/conversation/contactpicker/limitdialog/GroupLimitAlertDialogFragment", 95, ufh.class, "CreateComponent");
                    try {
                        Object objBb = bb();
                        eieuVarG.close();
                        eieu eieuVarG2 = eiiy.g("com/google/android/apps/messaging/conversation/contactpicker/limitdialog/GroupLimitAlertDialogFragment", 100, ufh.class, "CreatePeer");
                        try {
                            ahkn ahknVar = ((ahib) objBb).a;
                            eyik eyikVar = ((ahib) objBb).i;
                            eyik eyikVar2 = ((ahib) objBb).j;
                            ...
                            ufj ufjVar = (ufj) ProtoParsers.f(bundleA, "TIKTOK_FRAGMENT_ARGUMENT", ufj.a, evrrVar);
                            ufjVar.getClass();
                            this.ah = new ufk(eyikVar, eyikVar2, ufjVar);
                            eieuVarG2.close();
    ...
    public final Dialog gK(Bundle bundle) {
        super.gK(bundle);
        ufk ufkVarH = H();
        String strB = qxq.b(((ufh) ufkVarH.a.b()).z(), R.string.group_limit_alert_dialog_message, "max_group_size_excluding_self", Integer.valueOf(ufkVarH.c.b));
        eimy eimyVarA = ((eimz) ufkVarH.b.b()).a();
        eimyVarA.b(strB);
        ejwl.m(eimyVarA.a == -1, "Cannot set positive button multiple times.");
        eimyVarA.a = android.R.string.ok;
        return eimyVarA.a();
    }
    ...
    @Override // defpackage.ufm, defpackage.ea
