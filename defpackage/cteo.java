...
class cteo extends dn implements eyhy {
    ...
    protected final void aW() {
        ...
        this.ak = true;
        ctev ctevVar = (ctev) this;
        ahib ahibVar = (ahib) bb();
        ahkn ahknVar = ahibVar.a;
        ahnh ahnhVar = ahknVar.a;
        ctevVar.ag = (cgbn) ahnhVar.Cs.b();
        ctevVar.ah = (cmqa) ahnhVar.alx.b();
        ctevVar.ak = ahknVar.b.aX();
        eyik eyikVar = ahnhVar.rF;
        ahho ahhoVar = ahibVar.b;
        ctevVar.ai = new cavd(eyikVar);
    }
