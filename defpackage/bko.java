...
public final class bko implements bni, bku, bro {
    public static final bjo a = new bhd("camerax.core.imageAnalysis.backpressureStrategy", baf.class, null);
    public static final bjo b = new bhd("camerax.core.imageAnalysis.imageQueueDepth", Integer.TYPE, null);
    public static final bjo c = new bhd("camerax.core.imageAnalysis.imageReaderProxyProvider", bbn.class, null);
    public static final bjo d = new bhd("camerax.core.imageAnalysis.outputImageFormat", bai.class, null);
    public static final bjo e = new bhd("camerax.core.imageAnalysis.onePixelShiftEnabled", Boolean.class, null);
    public static final bjo f = new bhd("camerax.core.imageAnalysis.outputImageRotationEnabled", Boolean.class, null);
    private final blo h;

    public bko(blo bloVar) {
        this.h = bloVar;
    }
    ...
    public final int H() {
        return ((Integer) blz.c(this, a, 0)).intValue();
    }
