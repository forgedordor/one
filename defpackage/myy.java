...
public final class myy implements myk {
    protected myy() {
    }

    protected static int a(int i, int i2, int i3) {
        return eonc.a(((i * i2) * i3) / 1000000);
    }
    ...
    */
    public static int b(int r2) {
        ...
        L48:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.myy.b(int):int");
    }
}
