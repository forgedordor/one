...
public final class echi implements ecer {
    public boolean a;
    ...
    */
    private final void b(defpackage.ecev r3, android.net.Uri r4, java.util.List r5) {
        /*
            r2 = this;
            echf r0 = new echf
            r0.<init>()
        ...
        L51:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.echi.b(ecev, android.net.Uri, java.util.List):void");
    }

    @Override // defpackage.ecer
    public final /* bridge */ /* synthetic */ Object a(eceq eceqVar) throws IOException {
        ArrayList arrayList = new ArrayList();
        b(eceqVar.a, eceqVar.f, arrayList);
