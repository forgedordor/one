...
public final class abbn extends abbk implements ehlg, eyhx, ehlc, ehnw, eifl {
    private abbp ah;
    private Context ai;
    ...
    public final View M(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        try {
            ...
            abbv abbvVar = H().a;
            abbvVar.d = (TakeBugReportDialogView) layoutInflater.inflate(R.layout.diagnostics_dialog, (ViewGroup) null);
            TakeBugReportDialogView takeBugReportDialogView = abbvVar.d;
            this.al = false;
            eidc.q();
    ...
    @Override // defpackage.abbk, defpackage.ecdn, defpackage.ea
    ...
    @Override // defpackage.abbk, defpackage.dn, defpackage.ea
    public final void g(Context context) {
        ...
        try {
            ...
            if (this.ah == null) {
                try {
                    eieu eieuVarG = eiiy.g("com/google/android/apps/messaging/diagnostics/sensor/ui/TakeBugReportDialogFragment", 97, abbn.class, "CreateComponent");
                    try {
                        Object objBb = bb();
                        eieuVarG.close();
                        eieu eieuVarG2 = eiiy.g("com/google/android/apps/messaging/diagnostics/sensor/ui/TakeBugReportDialogFragment", 102, abbn.class, "CreatePeer");
                        try {
                            ea eaVar = (ea) ((eyig) ((ahib) objBb).d).a;
                            if (!(eaVar instanceof abbn)) {
                                throw new IllegalStateException(a.M(eaVar, abbp.class));
                            }
                            this.ah = new abbp((abbn) eaVar, new abbv((achu) ((ahib) objBb).b.bA.b(), (ajhd) ((ahib) objBb).a.a.yw.b()));
                            eieuVarG2.close();
    ...
    @Override // defpackage.abbk, defpackage.ea
