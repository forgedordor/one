...
public final class cozt implements cozo {
    private final fcsu a;

    public cozt(fcsu fcsuVar) {
        fcsuVar.getClass();
        this.a = fcsuVar;
    }
    ...
    public final Object a(Set set, fcxy fcxyVar) {
        ...
        ewwt ewwtVar = ewwt.RCS_TRANSPORT_TYPE_DUAL_REGISTRATION;
    ...
    public final Object b(cozu cozuVar, fcxy fcxyVar) {
        Object objC = fdxs.c(((cies) this.a.b()).b(ewwt.RCS_TRANSPORT_TYPE_DUAL_REGISTRATION, cozuVar.b), fcxyVar);
        return objC == fcyl.a ? objC : fctx.a;
    }
