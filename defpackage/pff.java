...
public final class pff implements pjv, pju {
    ...
    public static final pff a(String str, int i) {
        TreeMap treeMap = a;
        synchronized (treeMap) {
            Map.Entry entryCeilingEntry = treeMap.ceilingEntry(Integer.valueOf(i));
            if (entryCeilingEntry == null) {
                pff pffVar = new pff(i);
                pffVar.i(str, i);
                return pffVar;
            }
            treeMap.remove(entryCeilingEntry.getKey());
            pff pffVar2 = (pff) entryCeilingEntry.getValue();
            pffVar2.i(str, i);
            pffVar2.getClass();
            return pffVar2;
        }
    ...
    public final void h(pju pjuVar) {
        ...
        while (true) {
            ...
            if (i3 == 1) {
                ...
                pjuVar.e(i2, this.b[i2]);
            } else if (i3 == 3) {
                pjuVar.d(i2, this.c[i2]);
            } else if (i3 == 4) {
