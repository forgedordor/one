...
class acvq extends ecdv implements eyhy {
    private ContextWrapper ag;
    private boolean ah;
    private volatile ehok ai;
    private final Object aj = new Object();
    private boolean ak = false;

    private final void aV() {
        if (this.ag == null) {
            this.ag = new ehol.a(super.z(), this);
    ...
    public LayoutInflater go(Bundle bundle) {
        ...
        return layoutInflaterGo.cloneInContext(new ehol.a(layoutInflaterGo, this));
    }
