...
public final class bpzr extends dqwl<bpze, bpzr, bpzs, bpyn, bpzd> {
    public bpzr(dqwv dqwvVar) {
        super(dqwvVar);
    }
    ...
    public final /* synthetic */ dqqj a(dqsy dqsyVar, Cursor cursor, String[] strArr, dqxe[] dqxeVarArr, dqwj dqwjVar, dqtm dqtmVar) {
        return new bpzk(dqsyVar, cursor, strArr, dqxeVarArr, dqwjVar, dqtmVar, this);
    }
