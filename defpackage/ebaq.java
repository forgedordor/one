...
public final class ebaq implements eayv {
    private static final ekrg a = ekrg.c("com/google/android/libraries/privatetelemetry/mobalt/observations/CountObservationGenerator");
    ...
    public ebaq(ebbg ebbgVar, ebbe ebbeVar, ebat ebatVar, SecureRandom secureRandom, int i, int i2, ejrp ejrpVar, ejsi ejsiVar) {
        this.b = ebbgVar;
        this.c = ebbeVar;
        this.d = ebatVar;
        this.e = secureRandom;
    ...
    */
    public final /* synthetic */ java.util.List a(int r37, java.util.List r38) {
        /*
            Method dump skipped, instructions count: 797
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ebaq.a(int, java.util.List):java.util.List");
    }
}
