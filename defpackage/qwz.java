...
public final class qwz {
    private static final ThreadLocal b = new qwv();
    private static final ThreadLocal c = new qww();
    private static final ThreadLocal d = new qwx();
    public static final ThreadLocal a = new qwy();
    ...
    public static void e(Path path, float f, float f2, float f3) {
        ...
        if (fMin >= length && fMax >= length) {
            fMin = qwu.b(fMin, length);
            fMax = qwu.b(fMax, length);
        }
        if (fMin < 0.0f) {
            fMin = qwu.b(fMin, length);
        }
