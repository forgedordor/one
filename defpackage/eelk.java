...
public class eelk extends ue {
    ...
    public eelk(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public eelk(Context context, AttributeSet attributeSet, int i) {
        ...
        this.a = true;
        this.b = false;
        TypedArray typedArrayA = eemh.a(context, attributeSet, eelw.b, i, 0, new int[0]);
