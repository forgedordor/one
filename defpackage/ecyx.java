...
class ecyx extends ea implements eyhy, eyhr {
    ...
    protected final void b() {
        if (p(X()) && !this.as) {
            this.as = true;
            ecyv ecyvVar = (ecyv) this;
            ahib ahibVar = (ahib) bb();
            ecyvVar.a = ahibVar.b();
            ahhk ahhkVar = ahibVar.c;
            eyik eyikVar = ahhkVar.bR;
            ahng ahngVar = ahibVar.a.b;
            ecyvVar.b = new eddf(eyikVar, ahngVar.iZ, ahngVar.ja, ahngVar.jc, ahhkVar.cj);
            ecyvVar.ar = ahhkVar.ab();
            ecyvVar.c = (dsvx) ahngVar.ja.b();
            ecyvVar.d = (dswb) ahngVar.iZ.b();
            ecyvVar.e = (edgv) ahhkVar.bC.b();
            ecyvVar.ag = (edgt) ahibVar.ch.b();
            ecyvVar.ah = (edgp) ahhkVar.co.b();
            ecyvVar.ai = (eduu) ahhkVar.cT.b();
        }
    }
