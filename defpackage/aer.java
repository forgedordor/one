...
public final class aer extends ContextWrapper {
    ...
    */
    private final android.content.res.Resources b() {
        /*
            ...
            if (r0 == 0) goto L2c
            android.content.res.Configuration r1 = defpackage.aer.b
            if (r1 != 0) goto L16
        ...
        L32:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.aer.b():android.content.res.Resources");
    }
    ...
    public aer(Context context, Resources.Theme theme) {
        super(context);
        this.c = theme;
    }
}
