...
public final class cncs extends cayv {
    public static final eksp a = eksp.c("BugleTachygram");
    private final cnfv b;
    private final fcsu c;

    public cncs(cnfv cnfvVar, fcsu fcsuVar) {
        this.b = cnfvVar;
        this.c = fcsuVar;
    }
    ...
    public final eieu b() {
        return eiiy.k("TachygramGetGroupInfoWorkHandler");
    }

    @Override // defpackage.cazg
    public final evuo d() {
        return auii.a.getParserForType();
    }
    ...
    protected final /* bridge */ /* synthetic */ eiju j(cayy cayyVar, evuh evuhVar) {
        return this.b.c(cayyVar, (auii) evuhVar);
    }
}
