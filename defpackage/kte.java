...
public final class kte extends ViewGroup.MarginLayoutParams {
    public int A;
    public int B;
    public int C;
    public int D;
    ...
    public final void a() {
        ...
        this.ae = true;
        this.af = true;
        if (!(this.av instanceof ksd)) {
            this.av = new ksd();
        }
        ((ksd) this.av).ag(this.Z);
    }
    ...
    */
    public final void resolveLayoutDirection(int r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.kte.resolveLayoutDirection(int):void");
    }

    public kte(Context context, AttributeSet attributeSet) throws NumberFormatException {
        ...
        this.av = new krz();
        this.aw = false;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, ktt.b);
        int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = typedArrayObtainStyledAttributes.getIndex(i);
            int i2 = ktd.a.get(index);
            switch (i2) {
                case 1:
                ...
                default:
                    switch (i2) {
                        case 44:
                            ktp.m(this, typedArrayObtainStyledAttributes.getString(index));
                            break;
                        case 45:
                        ...
                        default:
                            switch (i2) {
                                case 64:
                                    ktp.l(this, typedArrayObtainStyledAttributes, index, 0);
                                    this.E = true;
                                    break;
                                case 65:
                                    ktp.l(this, typedArrayObtainStyledAttributes, index, 1);
                                    this.F = true;
                                    break;
                                case 66:
    ...
    public kte(ViewGroup.LayoutParams layoutParams) {
        super(layoutParams);
        this.a = -1;
        this.b = -1;
        this.c = -1.0f;
