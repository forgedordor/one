...
public final class bnyo extends dqwl<bnyd, bnyo, bnyp, ConversationNotificationSettingsTable.BindData, bnyc> {
    public bnyo(dqwv dqwvVar) {
        super(dqwvVar);
    }
    ...
    public final /* synthetic */ dqqj a(dqsy dqsyVar, Cursor cursor, String[] strArr, dqxe[] dqxeVarArr, dqwj dqwjVar, dqtm dqtmVar) {
        return new bnyi(dqsyVar, cursor, strArr, dqxeVarArr, dqwjVar, dqtmVar, this);
    }
