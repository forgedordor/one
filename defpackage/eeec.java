...
public final class eeec extends ljm {
    final /* synthetic */ SwipeDismissBehavior a;
    private int b;
    private int c = -1;

    public eeec(SwipeDismissBehavior swipeDismissBehavior) {
    ...
    public final void c(int i) {
        eeuf eeufVar = this.a.f;
        if (eeufVar != null) {
            if (i != 0) {
                eeuq.a().e(eeufVar.a.t);
            } else {
                eeuq.a().f(eeufVar.a.t);
            }
        }
    }
    ...
    */
    public final void d(android.view.View r7, float r8, float r9) {
        ...
        L7f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.eeec.d(android.view.View, float, float):void");
    }
    ...
    public final void i(View view, int i, int i2) {
        ...
        if (fAbs <= f) {
            ...
            view.setAlpha(SwipeDismissBehavior.u(1.0f - ((fAbs - f) / (width2 - f))));
        }
    }
}
