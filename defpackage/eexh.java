...
public final class eexh {
    ...
    public static Context b(Context context, AttributeSet attributeSet, int i, int i2, int[] iArr) {
        ...
        boolean z = (context instanceof aer) && ((aer) context).a == i3;
        if (i3 == 0 || z) {
            return context;
        }
        aer aerVar = new aer(context, i3);
        int[] iArrC = c(context, attributeSet, iArr, i, i2);
        int length = iArrC.length;
        for (int i4 = 0; i4 < length; i4 = 1) {
            int i5 = iArrC[0];
            if (i5 != 0) {
                aerVar.getTheme().applyStyle(i5, true);
            }
        }
        ...
        if (resourceId != 0) {
            aerVar.getTheme().applyStyle(resourceId, true);
        }
        return aerVar;
    }
