...
public final class erdw {
    ...
    static erdv a(erdv erdvVar, erdv erdvVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        if (erdvVar.a()) {
            return erdvVar2;
        }
        if (erdvVar2.a()) {
        ...
        BigInteger bigInteger3 = erdvVar.d;
        BigInteger bigIntegerMod = bigInteger3.multiply(bigInteger3).mod(bigInteger2);
        BigInteger bigInteger4 = erdvVar2.d;
        BigInteger bigIntegerMod2 = bigInteger4.multiply(bigInteger4).mod(bigInteger2);
        BigInteger bigIntegerMod3 = erdvVar.b.multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod4 = erdvVar2.b.multiply(bigIntegerMod).mod(bigInteger2);
        BigInteger bigIntegerMod5 = erdvVar.c.multiply(bigInteger4).mod(bigInteger2).multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod6 = erdvVar2.c.multiply(bigInteger3).mod(bigInteger2).multiply(bigIntegerMod).mod(bigInteger2);
        if (bigIntegerMod3.equals(bigIntegerMod4)) {
            return !bigIntegerMod5.equals(bigIntegerMod6) ? erdv.a : b(erdvVar, bigInteger, bigInteger2);
        }
        ...
        return new erdv(bigIntegerMod12, bigIntegerMod13, bigIntegerAdd.multiply(bigIntegerAdd).mod(bigInteger2).subtract(bigIntegerMod).subtract(bigIntegerMod2).multiply(bigIntegerMod7).mod(bigInteger2));
    }

    static erdv b(erdv erdvVar, BigInteger bigInteger, BigInteger bigInteger2) {
        BigInteger bigInteger3 = erdvVar.c;
        if (bigInteger3.equals(BigInteger.ZERO)) {
            return erdv.a;
        }
        BigInteger bigInteger4 = erdvVar.b;
        ...
        BigInteger bigInteger5 = erdvVar.d;
        ...
        return new erdv(bigIntegerMod5, bigIntegerMod6, bigIntegerAdd3.multiply(bigIntegerAdd3).mod(bigInteger2).subtract(bigIntegerMod2).subtract(bigIntegerMod4).mod(bigInteger2));
    }

    static erdv c(ECPoint eCPoint, BigInteger bigInteger) {
        if (eCPoint.equals(ECPoint.POINT_INFINITY)) {
            return erdv.a;
        }
        BigInteger bigIntegerMod = new BigInteger(1, erfy.b((bigInteger.bitLength() + 8) / 8)).mod(bigInteger);
        BigInteger bigIntegerMod2 = bigIntegerMod.multiply(bigIntegerMod).mod(bigInteger);
        return new erdv(eCPoint.getAffineX().multiply(bigIntegerMod2).mod(bigInteger), eCPoint.getAffineY().multiply(bigIntegerMod2.multiply(bigIntegerMod).mod(bigInteger)).mod(bigInteger), bigIntegerMod);
    }
    ...
    public static ECPoint e(BigInteger bigInteger, ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        ...
        erdv erdvVarC = c(ECPoint.POINT_INFINITY, bigIntegerD);
        erdv erdvVarC2 = c(generator, bigIntegerD);
        for (int iBitLength = bigInteger.bitLength(); iBitLength >= 0; iBitLength--) {
            if (bigInteger.testBit(iBitLength)) {
                erdvVarC = a(erdvVarC, erdvVarC2, a2, bigIntegerD);
                erdvVarC2 = b(erdvVarC2, a2, bigIntegerD);
            } else {
                erdvVarC2 = a(erdvVarC, erdvVarC2, a2, bigIntegerD);
                erdvVarC = b(erdvVarC, a2, bigIntegerD);
            }
        }
        if (erdvVarC.a()) {
            eCPoint = ECPoint.POINT_INFINITY;
        } else {
            BigInteger bigIntegerModInverse = erdvVarC.d.modInverse(bigIntegerD);
            BigInteger bigIntegerMod = bigIntegerModInverse.multiply(bigIntegerModInverse).mod(bigIntegerD);
            eCPoint = new ECPoint(erdvVarC.b.multiply(bigIntegerMod).mod(bigIntegerD), erdvVarC.c.multiply(bigIntegerMod).mod(bigIntegerD).multiply(bigIntegerModInverse).mod(bigIntegerD));
        }
        f(eCPoint, curve);
        return eCPoint;
    }
