...
public final class qvl implements qwi {
    private int a;
    ...
    public final /* bridge */ /* synthetic */ Object a(qwn qwnVar, float f) {
        ...
        while (qwnVar.o()) {
            arrayList.add(Float.valueOf((float) qwnVar.a()));
        }
        int i2 = 2;
        char c2 = 0;
        ...
        qtp qtpVar = new qtp(fArr, iArr);
        if (arrayList.size() <= i) {
            return qtpVar;
        }
        float[] fArr2 = qtpVar.a;
        int[] iArr2 = qtpVar.b;
        ...
        while (i14 < length2) {
            ...
            if (iBinarySearch < 0 || iBinarySearch2 > 0) {
                ...
                if (iArr2.length < i2 || f7 == fArr2[c]) {
                    ...
                    iArgb = Color.argb((int) (f8 * 255.0f), qwq.a(f10, Color.red(i18), Color.red(i17)), qwq.a(f10, Color.green(i18), Color.green(i17)), qwq.a(f10, Color.blue(i18), Color.blue(i17)));
                }
                iArr3[i14] = iArgb;
            } else {
        ...
        return new qtp(fArrCopyOf, iArr3);
    }
}
