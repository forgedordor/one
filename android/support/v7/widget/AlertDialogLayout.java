...
public class AlertDialogLayout extends ue {
        ...
        if (mode2 != 1073741824) {
            ...
            while (i9 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ud udVar = (ud) childAt3.getLayoutParams();
                    if (udVar.width == -1) {
                        int i11 = udVar.height;
                        udVar.height = childAt3.getMeasuredHeight();
