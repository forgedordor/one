...
public class ListMenuItemView extends LinearLayout implements AbsListView.SelectionBoundsAdjuster, oq {
    public of a;
    public ImageView b;
    public boolean c;
    public boolean d;
    ...
    /* JADX WARN: Type inference failed for: r11v0, types: [android.support.v7.view.menu.ListMenuItemView, android.view.ViewGroup, oq] */
    ...
    public final void f(of ofVar) {
        ...
        CharSequence charSequenceF = ofVar.f(this);
        ...
        if (i == 0) {
            ...
            if (cE == 0) {
                ...
                int i2 = ocVar.x() ? ofVar2.j : ofVar2.h;
                of.g(sb, i2, 65536, resources.getString(R.string.abc_menu_meta_shortcut_label));
                of.g(sb, i2, 4096, resources.getString(R.string.abc_menu_ctrl_shortcut_label));
                of.g(sb, i2, 2, resources.getString(R.string.abc_menu_alt_shortcut_label));
                of.g(sb, i2, 1, resources.getString(R.string.abc_menu_shift_shortcut_label));
                of.g(sb, i2, 4, resources.getString(R.string.abc_menu_sym_shortcut_label));
                of.g(sb, i2, 8, resources.getString(R.string.abc_menu_function_shortcut_label));
                if (cE == '\b') {
        ...
        boolean zHasSubMenu = ofVar.hasSubMenu();
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        yx yxVarL = yx.l(getContext(), attributeSet, kt.t, i, 0);
        this.m = yxVarL.h(5);
        this.n = yxVarL.f(1, -1);
        this.c = yxVarL.p(7, false);
        this.o = context;
        this.p = yxVarL.h(8);
