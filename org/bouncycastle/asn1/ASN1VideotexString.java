...
public abstract class ASN1VideotexString extends ASN1Primitive implements ASN1String {
    ...
    /* compiled from: PG */
    /* renamed from: org.bouncycastle.asn1.ASN1VideotexString$1, reason: invalid class name */
    ...
    public ASN1VideotexString(byte[] bArr) {
        this.a = bArr;
    }
    ...
    public final void b(ASN1OutputStream aSN1OutputStream, boolean z) {
        aSN1OutputStream.j(z, 21, this.a);
    }

    @Override // org.bouncycastle.asn1.ASN1Primitive
    public final boolean c(ASN1Primitive aSN1Primitive) {
        if (aSN1Primitive instanceof ASN1VideotexString) {
            return Arrays.equals(this.a, ((ASN1VideotexString) aSN1Primitive).a);
        }
        return false;
    }
