...
public class IconCompatParcelizer {
    ...
    public static IconCompat read(por porVar) {
        IconCompat iconCompat = new IconCompat();
        iconCompat.b = porVar.b(iconCompat.b, 1);
        byte[] bArrB = iconCompat.d;
        if (porVar.A(2)) {
            bArrB = porVar.B();
        }
        iconCompat.d = bArrB;
        iconCompat.e = porVar.d(iconCompat.e, 3);
        iconCompat.f = porVar.b(iconCompat.f, 4);
        iconCompat.g = porVar.b(iconCompat.g, 5);
        iconCompat.h = (ColorStateList) porVar.d(iconCompat.h, 6);
        iconCompat.j = porVar.j(iconCompat.j, 7);
        iconCompat.k = porVar.j(iconCompat.k, 8);
    ...
    public static void write(IconCompat iconCompat, por porVar) {
