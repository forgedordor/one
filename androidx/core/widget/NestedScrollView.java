...
public class NestedScrollView extends FrameLayout implements ldl, ldi {
    private static final float h = (float) (Math.log(0.78d) / Math.log(0.9d));
    private static final lij i = new lij();
    ...
    */
    ...
    private final boolean L(EdgeEffect edgeEffect, int i2) {
        ...
        float fA = lih.a(edgeEffect) * getHeight();
    ...
    private final boolean M(MotionEvent motionEvent) {
        ...
        lih.b(this.c, 0.0f, 1.0f - (motionEvent.getX() / getWidth()));
        return true;
    }
    ...
    */
    ...
    final int i(int i2, int i3, MotionEvent motionEvent, int i4, int i5, boolean z) {
        ...
        boolean z4 = s(i6, 0, scrollY, iC) && !p(i5);
        int scrollY2 = getScrollY() - scrollY;
        ...
        if (i11 < 0) {
            if (z3) {
                lih.b(this.b, (-i10) / getHeight(), i4 / getWidth());
                if (motionEvent != null) {
                    y().a(motionEvent.getDeviceId(), motionEvent.getSource(), i3, z2);
                }
                if (!this.c.isFinished()) {
                    this.c.onRelease();
                }
            ...
            lih.b(this.c, i10 / getHeight(), 1.0f - (i4 / getWidth()));
            if (motionEvent != null) {
                y().a(motionEvent.getDeviceId(), motionEvent.getSource(), i3, i8);
            }
            if (!this.b.isFinished()) {
                this.b.onRelease();
            }
    ...
    public final void j(int i2) {
        if (getChildCount() > 0) {
            ...
            if (Build.VERSION.SDK_INT >= 35) {
                lik.a(this, Math.abs(this.a.getCurrVelocity()));
            }
        }
    }
    ...
    public final boolean l(int i2) {
        ...
        if (viewFindNextFocus == null || !J(viewFindNextFocus, height, getHeight())) {
        ...
        if (viewFindFocus == null || !viewFindFocus.isFocused() || !H(viewFindFocus)) {
            return true;
        }
    ...
    public final boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 8 && !this.r) {
            if (ldh.a(motionEvent, 2)) {
                axisValue = motionEvent.getAxisValue(9);
                i2 = 9;
                width = (int) motionEvent.getX();
            } else if (ldh.a(motionEvent, 4194304)) {
            ...
            if (axisValue != 0.0f) {
                i(-((int) (axisValue * a())), i2, motionEvent, width, 1, ldh.a(motionEvent, 8194));
    ...
    */
    ...
    protected final boolean onRequestFocusInDescendants(int i2, Rect rect) {
        ...
        if (viewFindNextFocus == null || H(viewFindNextFocus)) {
            return false;
        }
    ...
    protected final void onRestoreInstanceState(Parcelable parcelable) {
        ...
        super.onRestoreInstanceState(linVar.getSuperState());
        this.D = linVar;
        requestLayout();
    }
    ...
    protected final void onSizeChanged(int i2, int i3, int i4, int i5) {
        ...
        View viewFindFocus = findFocus();
        if (viewFindFocus == null || this == viewFindFocus || !J(viewFindFocus, 0, i5)) {
            return;
        }
        Rect rect = this.m;
    ...
    */
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.e = lilVar;
        this.f = new lcx(getContext(), lilVar);
        this.b = lih.c(context, attributeSet);
        this.c = lih.c(context, attributeSet);
