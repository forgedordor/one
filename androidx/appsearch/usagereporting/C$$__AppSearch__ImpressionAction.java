...
public final class C$$__AppSearch__ImpressionAction implements afq<ImpressionAction> {
    @Override // defpackage.afq
    public final afo a() {
        afb afbVar = new afb("builtin:ImpressionAction");
    ...
    public final /* bridge */ /* synthetic */ afv b(Object obj) {
        ...
        afu afuVar = new afu(impressionAction.f, impressionAction.g, "builtin:ImpressionAction");
        afuVar.d(impressionAction.h);
        afuVar.g(impressionAction.i);
        afuVar.k("actionType", impressionAction.j);
        ...
        afuVar.k("resultRankInBlock", impressionAction.c);
        afuVar.k("resultRankGlobal", impressionAction.d);
        return afuVar.e();
    }
    ...
    public final /* bridge */ /* synthetic */ Object c(afv afvVar, afs afsVar) {
        ...
        return new ImpressionAction(strL, strK, jE, jC, iD, str2, str, (int) afvVar.d("resultRankInBlock"), (int) afvVar.d("resultRankGlobal"));
    }
