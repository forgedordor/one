...
public class DistinctElementSidecarCallback implements SidecarInterface.SidecarCallback {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:12:0x001a, code lost:
        ...
        if (defpackage.pxy.a(r1) == defpackage.pxy.a(r4)) goto L13;
     */
    /*
    ...
    */
    public void onDeviceStateChanged(androidx.window.sidecar.SidecarDeviceState r4) {
        ...
        L3:
            ...
            boolean r2 = defpackage.fdbq.f(r1, r4)     // Catch: java.lang.Throwable -> L27
            if (r2 == 0) goto Lf
            goto L1c
        Lf:
            if (r1 != 0) goto L12
            goto L1e
        L12:
            int r1 = defpackage.pxy.a(r1)     // Catch: java.lang.Throwable -> L27
            int r2 = defpackage.pxy.a(r4)     // Catch: java.lang.Throwable -> L27
            if (r1 != r2) goto L1e
        L1c:
    ...
    public void onWindowLayoutChanged(IBinder iBinder, SidecarWindowLayoutInfo sidecarWindowLayoutInfo) {
        synchronized (this.a) {
            ...
            if (!fdbq.f(sidecarWindowLayoutInfo2, sidecarWindowLayoutInfo)) {
                if (sidecarWindowLayoutInfo2 != null && sidecarWindowLayoutInfo != null) {
                    List listB = pxy.b(sidecarWindowLayoutInfo2);
                    List listB2 = pxy.b(sidecarWindowLayoutInfo);
                    if (listB != listB2) {
                        if (listB.size() == listB2.size()) {
                            ...
                            for (int i = 0; i < size; i++) {
                                ...
                                if (!fdbq.f(sidecarDisplayFeature, sidecarDisplayFeature2)) {
                                    if (sidecarDisplayFeature != null && sidecarDisplayFeature2 != null && sidecarDisplayFeature.getType() == sidecarDisplayFeature2.getType() && fdbq.f(sidecarDisplayFeature.getRect(), sidecarDisplayFeature2.getRect())) {
                                    }
                                }
                            }
                        }
